...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    /* access modifiers changed from: private */
    public static final int MIN_PARK_TIME_NS = ((int) RangesKt.coerceAtMost(RangesKt.coerceAtLeast(TasksKt.WORK_STEALING_TIME_RESOLUTION_NS / ((long) 4), 10L), (long) MAX_PARK_TIME_NS));
    ...
    public final void shutdown(long r9) {
        ...
        L_0x0014:
            ...
            monitor-enter(r3)
            long r4 = r8.controlState     // Catch:{ all -> 0x00d1 }
    ...
    private final int createNewWorker() {
        ...
        L_0x000c:
            ...
            int r2 = (int) r1
            int r1 = r6 - r2
            int r2 = r9.corePoolSize
            r5 = 0
            if (r1 < r2) goto L_0x0027
            monitor-exit(r0)
            return r5
        L_0x0027:
            int r2 = r9.maxPoolSize
            if (r6 >= r2) goto L_0x0066
            java.util.concurrent.Semaphore r2 = r9.cpuPermits
        ...
        L_0x0047:
            ...
            kotlinx.coroutines.scheduling.CoroutineScheduler$Worker r4 = new kotlinx.coroutines.scheduling.CoroutineScheduler$Worker
            r4.<init>(r9, r3)
            r4.start()
            kotlinx.coroutines.scheduling.CoroutineScheduler$Worker[] r5 = r9.workers
            r5[r3] = r4
            int r1 = r1 + r2
            monitor-exit(r0)
            return r1
        ...
        for (Worker worker : workerArr) {
            if (worker != null) {
                ...
                if (i6 == 1) {
                    ...
                    i2++;
                    arrayList.add(String.valueOf(size$kotlinx_coroutines_core) + HtmlTags.B);
                } else if (i6 == 3) {
                    i++;
