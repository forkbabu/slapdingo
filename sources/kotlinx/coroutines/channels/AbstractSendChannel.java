    ...
    public final /* synthetic */ Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (access$enqueueSend == null) {
                ...
                cancellableContinuation.resumeWith(Result.m5constructorimpl(ResultKt.createFailure(sendException)));
                break;
            } else {
                Object offerInternal = offerInternal(e);
                if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                    ...
                    if (offerInternal instanceof Closed) {
                        ...
                        cancellableContinuation.resumeWith(Result.m5constructorimpl(ResultKt.createFailure(sendException2)));
                    } else {
                        throw new IllegalStateException(("offerInternal returned " + offerInternal).toString());
                    }
                }
