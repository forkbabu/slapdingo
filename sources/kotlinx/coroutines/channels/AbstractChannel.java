...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    /* compiled from: AbstractChannel.kt */
    private final class TryEnqueueReceiveDesc<E, R> extends LockFreeLinkedListNode.AddLastDesc<AbstractChannel<E>.ReceiveSelect> {
                ...
                if (!getChannel().enqueueReceive(receive)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            cancellableContinuation.resumeWith(Result.m5constructorimpl(boxBoolean));
                            break;
                        }
                    } else {
                        ...
                        if (closed.closeCause == null) {
                            ...
                            cancellableContinuation.resumeWith(Result.m5constructorimpl(boxBoolean2));
                        } else {
                            Throwable receiveException = closed.getReceiveException();
                            Result.Companion companion3 = Result.Companion;
                            cancellableContinuation.resumeWith(Result.m5constructorimpl(ResultKt.createFailure(receiveException)));
                        }
                    }
                } else {
    ...
    private static final class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            ...
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m5constructorimpl(null));
        }
        ...
        while (true) {
            ...
            if (!enqueueReceive(receive)) {
                ...
                if (!(pollInternal instanceof Closed)) {
                    if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                        Result.Companion companion = Result.Companion;
                        cancellableContinuation.resumeWith(Result.m5constructorimpl(pollInternal));
                        break;
                    }
                } else {
