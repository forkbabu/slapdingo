...
final class SupportedParameters$supportedAutoBandingModes$2 extends Lambda implements Function0<List<? extends String>> {
    final /* synthetic */ SupportedParameters this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SupportedParameters$supportedAutoBandingModes$2(SupportedParameters supportedParameters) {
        super(0);
