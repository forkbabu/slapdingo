...
final class SupportedParameters$pictureResolutions$2 extends Lambda implements Function0<List<Camera.Size>> {
    final /* synthetic */ SupportedParameters this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SupportedParameters$pictureResolutions$2(SupportedParameters supportedParameters) {
        super(0);
