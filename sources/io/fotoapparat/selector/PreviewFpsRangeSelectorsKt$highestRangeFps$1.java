...
final class PreviewFpsRangeSelectorsKt$highestRangeFps$1 extends Lambda implements Function1<Iterable<? extends FpsRange>, FpsRange> {
    ...
    public final FpsRange invoke(Iterable<FpsRange> iterable) {
        ...
        return (FpsRange) CollectionsKt.maxWith(iterable, CompareFpsRangeByBounds.INSTANCE);
    }
}
