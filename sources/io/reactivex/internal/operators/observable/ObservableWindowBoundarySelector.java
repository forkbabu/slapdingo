            ...
            while (true) {
                ...
                if (z && z2) {
                    ...
                    if (((WindowOperation) t).w != null) {
                        ...
                        try {
                            ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.close.apply(((WindowOperation) t).open), "The ObservableSource supplied is null");
