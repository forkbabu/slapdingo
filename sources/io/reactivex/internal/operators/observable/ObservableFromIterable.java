...
public final class ObservableFromIterable<T> extends Observable<T> {
    ...
    static final class FromIterableDisposable<T> extends BasicQueueDisposable<T> {
        ...
        final Iterator<? extends T> f60it;
        ...
        public void run() {
            while (!isDisposed()) {
                try {
                    this.actual.onNext(ObjectHelper.requireNonNull(this.f60it.next(), "The iterator returned a null value"));
                    if (!isDisposed()) {
                        try {
        ...
        public T poll() {
            ...
            if (!this.checkNext) {
                this.checkNext = true;
            } else if (!this.f60it.hasNext()) {
                this.done = true;
                return null;
            }
            return ObjectHelper.requireNonNull(this.f60it.next(), "The iterator returned a null value");
        }
