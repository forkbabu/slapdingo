        ...
        public void drainLoop() {
            ...
            while (true) {
                ...
                if (z && z2) {
                    ...
                    T t = poll;
                    if (((WindowOperation) t).w != null) {
                        if (list.remove(((WindowOperation) t).w)) {
                        ...
                        if (requested != 0) {
                            ...
                            try {
                                Publisher publisher = (Publisher) ObjectHelper.requireNonNull(this.close.apply(((WindowOperation) t).open), "The publisher supplied is null");
                    ...
                    for (UnicastProcessor<T> unicastProcessor3 : list) {
                        unicastProcessor3.onNext(NotificationLite.getValue(poll));
                    }
                }
            }
        }
