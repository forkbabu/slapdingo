...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    private synchronized boolean send(okio.ByteString r7, int r8) {
        ...
        L_0x000b:
            ...
            return r1
        L_0x0022:
            long r0 = r6.queueSize
            int r2 = r7.size()
            long r2 = (long) r2
            long r0 = r0 + r2
            r6.queueSize = r0
            java.util.ArrayDeque<java.lang.Object> r0 = r6.messageAndCloseQueue
            okhttp3.internal.ws.RealWebSocket$Message r1 = new okhttp3.internal.ws.RealWebSocket$Message
            r1.<init>(r8, r7)
            r0.add(r1)
            r6.runWriter()
            r7 = 1
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x005c:
            ...
            okio.BufferedSink r0 = okio.Okio.buffer(r0)     // Catch:{ all -> 0x00ab }
            r0.write(r2)     // Catch:{ all -> 0x00ab }
        ...
        L_0x0089:
            ...
            throw r0
        L_0x008c:
            boolean r2 = r4 instanceof okhttp3.internal.ws.RealWebSocket.Close
            if (r2 == 0) goto L_0x00a5
            okhttp3.internal.ws.RealWebSocket$Close r4 = (okhttp3.internal.ws.RealWebSocket.Close) r4
            int r2 = r4.code
            okio.ByteString r4 = r4.reason
            r0.writeClose(r2, r4)
            if (r1 == 0) goto L_0x00a0
            okhttp3.WebSocketListener r0 = r12.listener
