...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public synchronized okhttp3.internal.cache.DiskLruCache.Snapshot get(java.lang.String r4) throws java.io.IOException {
        ...
        L_0x0022:
            ...
            int r1 = r1 + 1
            r3.redundantOpCount = r1
            okio.BufferedSink r1 = r3.journalWriter
            java.lang.String r2 = "READ"
            okio.BufferedSink r1 = r1.writeUtf8(r2)
            r2 = 32
            okio.BufferedSink r1 = r1.writeByte(r2)
            okio.BufferedSink r4 = r1.writeUtf8(r4)
            r1 = 10
            r4.writeByte(r1)
            boolean r4 = r3.journalRebuildRequired()
            if (r4 == 0) goto L_0x004c
            java.util.concurrent.Executor r4 = r3.executor
            java.lang.Runnable r1 = r3.cleanupRunnable
            r4.execute(r1)
        L_0x004c:
            monitor-exit(r3)
            return r0
    ...
    public synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        ...
        L_0x0023:
            ...
            okhttp3.internal.cache.DiskLruCache$Editor r7 = r0.currentEditor
            if (r7 == 0) goto L_0x002b
            monitor-exit(r5)
            return r3
        L_0x002b:
            boolean r7 = r5.mostRecentTrimFailed
            if (r7 != 0) goto L_0x006b
            boolean r7 = r5.mostRecentRebuildFailed
            if (r7 == 0) goto L_0x0034
            goto L_0x006b
        L_0x0034:
            okio.BufferedSink r7 = r5.journalWriter
            java.lang.String r8 = "DIRTY"
            okio.BufferedSink r7 = r7.writeUtf8(r8)
            r8 = 32
            okio.BufferedSink r7 = r7.writeByte(r8)
            okio.BufferedSink r7 = r7.writeUtf8(r6)
            r8 = 10
            r7.writeByte(r8)
            okio.BufferedSink r7 = r5.journalWriter
            r7.flush()
            boolean r7 = r5.hasJournalErrors
            if (r7 == 0) goto L_0x0056
            monitor-exit(r5)
            return r3
        L_0x0056:
            if (r0 != 0) goto L_0x0062
            okhttp3.internal.cache.DiskLruCache$Entry r0 = new okhttp3.internal.cache.DiskLruCache$Entry
            r0.<init>(r6)
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r7 = r5.lruEntries
            r7.put(r6, r0)
        L_0x0062:
            okhttp3.internal.cache.DiskLruCache$Editor r6 = new okhttp3.internal.cache.DiskLruCache$Editor
            r6.<init>(r0)
            r0.currentEditor = r6
            monitor-exit(r5)
            return r6
        L_0x006b:
            java.util.concurrent.Executor r6 = r5.executor
            java.lang.Runnable r7 = r5.cleanupRunnable
            r6.execute(r7)
            monitor-exit(r5)
            return r3
        L_0x0074:
    ...
    public synchronized void completeEdit(okhttp3.internal.cache.DiskLruCache.Editor r10, boolean r11) throws java.io.IOException {
        ...
        L_0x002d:
            ...
            throw r10
        L_0x0047:
            int r10 = r9.valueCount
            if (r1 >= r10) goto L_0x007f
            java.io.File[] r10 = r0.dirtyFiles
            r10 = r10[r1]
            if (r11 == 0) goto L_0x0077
            okhttp3.internal.io.FileSystem r2 = r9.fileSystem
            boolean r2 = r2.exists(r10)
            if (r2 == 0) goto L_0x007c
            java.io.File[] r2 = r0.cleanFiles
            r2 = r2[r1]
            okhttp3.internal.io.FileSystem r3 = r9.fileSystem
            r3.rename(r10, r2)
            long[] r10 = r0.lengths
            r3 = r10[r1]
            okhttp3.internal.io.FileSystem r10 = r9.fileSystem
            long r5 = r10.size(r2)
            long[] r10 = r0.lengths
            r10[r1] = r5
            long r7 = r9.size
        ...
        L_0x007c:
            ...
            goto L_0x0047
        L_0x007f:
            int r10 = r9.redundantOpCount
            r1 = 1
            int r10 = r10 + r1
            r9.redundantOpCount = r10
            r10 = 0
            r0.currentEditor = r10
            boolean r10 = r0.readable
            r10 = r10 | r11
            r2 = 10
            r3 = 32
            if (r10 == 0) goto L_0x00bb
            r0.readable = r1
            okio.BufferedSink r10 = r9.journalWriter
            java.lang.String r1 = "CLEAN"
            okio.BufferedSink r10 = r10.writeUtf8(r1)
            r10.writeByte(r3)
            okio.BufferedSink r10 = r9.journalWriter
            ...
            long r10 = r9.nextSequenceNumber
            r1 = 1
            long r1 = r1 + r10
            r9.nextSequenceNumber = r1
            r0.sequenceNumber = r10
            goto L_0x00d9
        L_0x00bb:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r10 = r9.lruEntries
        ...
        L_0x00d9:
            ...
            boolean r10 = r9.journalRebuildRequired()
            if (r10 == 0) goto L_0x00f3
        L_0x00ec:
            java.util.concurrent.Executor r10 = r9.executor
            java.lang.Runnable r11 = r9.cleanupRunnable
            r10.execute(r11)
        L_0x00f3:
            monitor-exit(r9)
            return
    ...
    public synchronized boolean remove(java.lang.String r7) throws java.io.IOException {
        /*
            ...
            return r0
        L_0x0017:
            boolean r7 = r6.removeEntry(r7)
            if (r7 == 0) goto L_0x0027
            long r1 = r6.size
            long r3 = r6.maxSize
            int r5 = (r1 > r3 ? 1 : (r1 == r3 ? 0 : -1))
            if (r5 > 0) goto L_0x0027
            r6.mostRecentTrimFailed = r0
        L_0x0027:
            monitor-exit(r6)
            return r7
        L_0x0029:
