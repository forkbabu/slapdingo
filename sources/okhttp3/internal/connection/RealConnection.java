...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        ...
        L_0x0041:
            ...
            r3.check(r0, r5)     // Catch:{ AssertionError -> 0x0103, all -> 0x0100 }
        ...
        L_0x007f:
            ...
            okio.Source r8 = okio.Okio.source(r1)     // Catch:{ AssertionError -> 0x0103, all -> 0x0100 }
            okio.BufferedSource r8 = okio.Okio.buffer(r8)     // Catch:{ AssertionError -> 0x0103, all -> 0x0100 }
            r7.source = r8     // Catch:{ AssertionError -> 0x0103, all -> 0x0100 }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0103, all -> 0x0100 }
            okio.Sink r8 = okio.Okio.sink(r8)     // Catch:{ AssertionError -> 0x0103, all -> 0x0100 }
            okio.BufferedSink r8 = okio.Okio.buffer(r8)     // Catch:{ AssertionError -> 0x0103, all -> 0x0100 }
        ...
        L_0x00ad:
            return
        L_0x00ae:
            java.util.List r8 = r4.peerCertificates()
            r2 = 0
            ...
            r3.append(r0)
            java.lang.String r0 = okhttp3.CertificatePinner.pin(r8)
            r3.append(r0)
            java.lang.String r0 = "\n    DN: "
            r3.append(r0)
            ...
            java.lang.String r0 = "\n    subjectAltNames: "
            r3.append(r0)
            java.util.List r8 = okhttp3.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)
            r3.append(r8)
