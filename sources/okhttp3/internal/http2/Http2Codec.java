...
public final class Http2Codec implements HttpCodec {
    ...
    public ResponseBody openResponseBody(Response response) throws IOException {
        ...
        return new RealResponseBody(response.header(HttpConnection.CONTENT_TYPE), HttpHeaders.contentLength(response), Okio.buffer(new StreamFinishingSource(this.stream.getSource())));
    }
