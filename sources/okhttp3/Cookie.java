...
public final class Cookie {
    ...
    private static boolean pathMatch(HttpUrl httpUrl, String str) {
        ...
        if (!str.endsWith(Constants.PATH_SEPERATOR) && encodedPath.charAt(str.length()) != '/') {
            return false;
        }
        return true;
    }
    ...
    static okhttp3.Cookie parse(long r23, okhttp3.HttpUrl r25, java.lang.String r26) {
        ...
        L_0x0085:
            ...
            java.lang.String r14 = parseDomain(r3)
            r17 = 0
            goto L_0x00b2
        L_0x0094:
    ...
    public static final class Builder {
        ...
        @Nullable
        String name;
        String path = Constants.PATH_SEPERATOR;
        boolean persistent;
        boolean secure;
        @Nullable
        String value;
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((MetaDo.META_OFFSETWINDOWORG + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + (!this.secure)) * 31) + (!this.httpOnly)) * 31) + (!this.persistent)) * 31) + (!this.hostOnly);
    }
}
