...
public class Features2d {
    ...
    public static void drawKeypoints(Mat mat, MatOfKeyPoint matOfKeyPoint, Mat mat2, Scalar scalar, int i) {
        drawKeypoints_0(mat.nativeObj, ((Mat) matOfKeyPoint).nativeObj, mat2.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i);
    }

    public static void drawKeypoints(Mat mat, MatOfKeyPoint matOfKeyPoint, Mat mat2) {
        drawKeypoints_1(mat.nativeObj, ((Mat) matOfKeyPoint).nativeObj, mat2.nativeObj);
    }
    ...
    public static void drawMatches(Mat mat, MatOfKeyPoint matOfKeyPoint, Mat mat2, MatOfKeyPoint matOfKeyPoint2, MatOfDMatch matOfDMatch, Mat mat3, Scalar scalar, Scalar scalar2, MatOfByte matOfByte, int i) {
        drawMatches_0(mat.nativeObj, ((Mat) matOfKeyPoint).nativeObj, mat2.nativeObj, ((Mat) matOfKeyPoint2).nativeObj, ((Mat) matOfDMatch).nativeObj, mat3.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], ((Mat) matOfByte).nativeObj, i);
    }
    ...
    public static void drawMatches(Mat mat, MatOfKeyPoint matOfKeyPoint, Mat mat2, MatOfKeyPoint matOfKeyPoint2, MatOfDMatch matOfDMatch, Mat mat3) {
        drawMatches_1(mat.nativeObj, ((Mat) matOfKeyPoint).nativeObj, mat2.nativeObj, ((Mat) matOfKeyPoint2).nativeObj, ((Mat) matOfDMatch).nativeObj, mat3.nativeObj);
    }
    ...
    public static void drawMatches2(Mat mat, MatOfKeyPoint matOfKeyPoint, Mat mat2, MatOfKeyPoint matOfKeyPoint2, List<MatOfDMatch> list, Mat mat3) {
        drawMatches2_1(mat.nativeObj, ((Mat) matOfKeyPoint).nativeObj, mat2.nativeObj, ((Mat) matOfKeyPoint2).nativeObj, Converters.vector_vector_DMatch_to_Mat(list, new ArrayList(list != null ? list.size() : 0)).nativeObj, mat3.nativeObj);
    }
    ...
    public static void drawMatchesKnn(Mat mat, MatOfKeyPoint matOfKeyPoint, Mat mat2, MatOfKeyPoint matOfKeyPoint2, List<MatOfDMatch> list, Mat mat3) {
        drawMatchesKnn_1(mat.nativeObj, ((Mat) matOfKeyPoint).nativeObj, mat2.nativeObj, ((Mat) matOfKeyPoint2).nativeObj, Converters.vector_vector_DMatch_to_Mat(list, new ArrayList(list != null ? list.size() : 0)).nativeObj, mat3.nativeObj);
    }
}
