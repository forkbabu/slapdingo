...
public class DescriptorMatcher extends Algorithm {
    ...
    public void match(Mat mat, Mat mat2, MatOfDMatch matOfDMatch, Mat mat3) {
        match_0(this.nativeObj, mat.nativeObj, mat2.nativeObj, ((Mat) matOfDMatch).nativeObj, mat3.nativeObj);
    }

    public void match(Mat mat, Mat mat2, MatOfDMatch matOfDMatch) {
        match_1(this.nativeObj, mat.nativeObj, mat2.nativeObj, ((Mat) matOfDMatch).nativeObj);
    }

    public void match(Mat mat, MatOfDMatch matOfDMatch, List<Mat> list) {
        match_2(this.nativeObj, mat.nativeObj, ((Mat) matOfDMatch).nativeObj, Converters.vector_Mat_to_Mat(list).nativeObj);
    }

    public void match(Mat mat, MatOfDMatch matOfDMatch) {
        match_3(this.nativeObj, mat.nativeObj, ((Mat) matOfDMatch).nativeObj);
    }
