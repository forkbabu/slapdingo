...
public class Feature2D extends Algorithm {
    ...
    public void compute(Mat mat, MatOfKeyPoint matOfKeyPoint, Mat mat2) {
        compute_0(this.nativeObj, mat.nativeObj, ((Mat) matOfKeyPoint).nativeObj, mat2.nativeObj);
    }
    ...
    public void detect(Mat mat, MatOfKeyPoint matOfKeyPoint, Mat mat2) {
        detect_0(this.nativeObj, mat.nativeObj, ((Mat) matOfKeyPoint).nativeObj, mat2.nativeObj);
    }

    public void detect(Mat mat, MatOfKeyPoint matOfKeyPoint) {
        detect_1(this.nativeObj, mat.nativeObj, ((Mat) matOfKeyPoint).nativeObj);
    }
    ...
    public void detectAndCompute(Mat mat, Mat mat2, MatOfKeyPoint matOfKeyPoint, Mat mat3, boolean z) {
        detectAndCompute_0(this.nativeObj, mat.nativeObj, mat2.nativeObj, ((Mat) matOfKeyPoint).nativeObj, mat3.nativeObj, z);
    }

    public void detectAndCompute(Mat mat, Mat mat2, MatOfKeyPoint matOfKeyPoint, Mat mat3) {
        detectAndCompute_1(this.nativeObj, mat.nativeObj, mat2.nativeObj, ((Mat) matOfKeyPoint).nativeObj, mat3.nativeObj);
    }
