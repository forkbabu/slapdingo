...
public class CascadeClassifier {
    ...
    public void detectMultiScale(Mat mat, MatOfRect matOfRect, double d, int i, int i2, Size size, Size size2) {
        detectMultiScale_0(this.nativeObj, mat.nativeObj, ((Mat) matOfRect).nativeObj, d, i, i2, size.width, size.height, size2.width, size2.height);
    }

    public void detectMultiScale(Mat mat, MatOfRect matOfRect) {
        detectMultiScale_1(this.nativeObj, mat.nativeObj, ((Mat) matOfRect).nativeObj);
    }

    public void detectMultiScale2(Mat mat, MatOfRect matOfRect, MatOfInt matOfInt, double d, int i, int i2, Size size, Size size2) {
        detectMultiScale2_0(this.nativeObj, mat.nativeObj, ((Mat) matOfRect).nativeObj, ((Mat) matOfInt).nativeObj, d, i, i2, size.width, size.height, size2.width, size2.height);
    }

    public void detectMultiScale2(Mat mat, MatOfRect matOfRect, MatOfInt matOfInt) {
        detectMultiScale2_1(this.nativeObj, mat.nativeObj, ((Mat) matOfRect).nativeObj, ((Mat) matOfInt).nativeObj);
    }
    ...
    public void detectMultiScale3(Mat mat, MatOfRect matOfRect, MatOfInt matOfInt, MatOfDouble matOfDouble, double d, int i, int i2, Size size, Size size2, boolean z) {
        detectMultiScale3_0(this.nativeObj, mat.nativeObj, ((Mat) matOfRect).nativeObj, ((Mat) matOfInt).nativeObj, ((Mat) matOfDouble).nativeObj, d, i, i2, size.width, size.height, size2.width, size2.height, z);
    }

    public void detectMultiScale3(Mat mat, MatOfRect matOfRect, MatOfInt matOfInt, MatOfDouble matOfDouble) {
        detectMultiScale3_1(this.nativeObj, mat.nativeObj, ((Mat) matOfRect).nativeObj, ((Mat) matOfInt).nativeObj, ((Mat) matOfDouble).nativeObj);
    }
