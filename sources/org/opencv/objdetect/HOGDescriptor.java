...
public class HOGDescriptor {
    ...
    public void compute(Mat mat, MatOfFloat matOfFloat, Size size, Size size2, MatOfPoint matOfPoint) {
        compute_0(this.nativeObj, mat.nativeObj, ((Mat) matOfFloat).nativeObj, size.width, size.height, size2.width, size2.height, ((Mat) matOfPoint).nativeObj);
    }

    public void compute(Mat mat, MatOfFloat matOfFloat) {
        compute_1(this.nativeObj, mat.nativeObj, ((Mat) matOfFloat).nativeObj);
    }
    ...
    public void detect(Mat mat, MatOfPoint matOfPoint, MatOfDouble matOfDouble, double d, Size size, Size size2, MatOfPoint matOfPoint2) {
        detect_0(this.nativeObj, mat.nativeObj, ((Mat) matOfPoint).nativeObj, ((Mat) matOfDouble).nativeObj, d, size.width, size.height, size2.width, size2.height, ((Mat) matOfPoint2).nativeObj);
    }

    public void detect(Mat mat, MatOfPoint matOfPoint, MatOfDouble matOfDouble) {
        detect_1(this.nativeObj, mat.nativeObj, ((Mat) matOfPoint).nativeObj, ((Mat) matOfDouble).nativeObj);
    }
    ...
    public void detectMultiScale(Mat mat, MatOfRect matOfRect, MatOfDouble matOfDouble, double d, Size size, Size size2, double d2, double d3, boolean z) {
        detectMultiScale_0(this.nativeObj, mat.nativeObj, ((Mat) matOfRect).nativeObj, ((Mat) matOfDouble).nativeObj, d, size.width, size.height, size2.width, size2.height, d2, d3, z);
    }

    public void detectMultiScale(Mat mat, MatOfRect matOfRect, MatOfDouble matOfDouble) {
        detectMultiScale_1(this.nativeObj, mat.nativeObj, ((Mat) matOfRect).nativeObj, ((Mat) matOfDouble).nativeObj);
    }
