...
public class Core {
    ...
    public static void meanStdDev(Mat mat, MatOfDouble matOfDouble, MatOfDouble matOfDouble2, Mat mat2) {
        meanStdDev_0(mat.nativeObj, ((Mat) matOfDouble).nativeObj, ((Mat) matOfDouble2).nativeObj, mat2.nativeObj);
    }

    public static void meanStdDev(Mat mat, MatOfDouble matOfDouble, MatOfDouble matOfDouble2) {
        meanStdDev_1(mat.nativeObj, ((Mat) matOfDouble).nativeObj, ((Mat) matOfDouble2).nativeObj);
    }
    ...
    public static void mixChannels(List<Mat> list, List<Mat> list2, MatOfInt matOfInt) {
        mixChannels_0(Converters.vector_Mat_to_Mat(list).nativeObj, Converters.vector_Mat_to_Mat(list2).nativeObj, ((Mat) matOfInt).nativeObj);
    }
