...
public class Video {
    ...
    public static void calcOpticalFlowPyrLK(Mat mat, Mat mat2, MatOfPoint2f matOfPoint2f, MatOfPoint2f matOfPoint2f2, MatOfByte matOfByte, MatOfFloat matOfFloat, Size size, int i, TermCriteria termCriteria, int i2, double d) {
        calcOpticalFlowPyrLK_0(mat.nativeObj, mat2.nativeObj, ((Mat) matOfPoint2f).nativeObj, ((Mat) matOfPoint2f2).nativeObj, ((Mat) matOfByte).nativeObj, ((Mat) matOfFloat).nativeObj, size.width, size.height, i, termCriteria.type, termCriteria.maxCount, termCriteria.epsilon, i2, d);
    }
    ...
    public static void calcOpticalFlowPyrLK(Mat mat, Mat mat2, MatOfPoint2f matOfPoint2f, MatOfPoint2f matOfPoint2f2, MatOfByte matOfByte, MatOfFloat matOfFloat, Size size, int i) {
        calcOpticalFlowPyrLK_1(mat.nativeObj, mat2.nativeObj, ((Mat) matOfPoint2f).nativeObj, ((Mat) matOfPoint2f2).nativeObj, ((Mat) matOfByte).nativeObj, ((Mat) matOfFloat).nativeObj, size.width, size.height, i);
    }
    ...
    public static void calcOpticalFlowPyrLK(Mat mat, Mat mat2, MatOfPoint2f matOfPoint2f, MatOfPoint2f matOfPoint2f2, MatOfByte matOfByte, MatOfFloat matOfFloat) {
        calcOpticalFlowPyrLK_2(mat.nativeObj, mat2.nativeObj, ((Mat) matOfPoint2f).nativeObj, ((Mat) matOfPoint2f2).nativeObj, ((Mat) matOfByte).nativeObj, ((Mat) matOfFloat).nativeObj);
    }
}
