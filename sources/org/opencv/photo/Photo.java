...
public class Photo {
    ...
    public static void fastNlMeansDenoising(Mat mat, Mat mat2, MatOfFloat matOfFloat, int i, int i2, int i3) {
        fastNlMeansDenoising_2(mat.nativeObj, mat2.nativeObj, ((Mat) matOfFloat).nativeObj, i, i2, i3);
    }

    public static void fastNlMeansDenoising(Mat mat, Mat mat2, MatOfFloat matOfFloat) {
        fastNlMeansDenoising_3(mat.nativeObj, mat2.nativeObj, ((Mat) matOfFloat).nativeObj);
    }
    ...
    public static void fastNlMeansDenoisingMulti(List<Mat> list, Mat mat, int i, int i2, MatOfFloat matOfFloat, int i3, int i4, int i5) {
        fastNlMeansDenoisingMulti_2(Converters.vector_Mat_to_Mat(list).nativeObj, mat.nativeObj, i, i2, ((Mat) matOfFloat).nativeObj, i3, i4, i5);
    }

    public static void fastNlMeansDenoisingMulti(List<Mat> list, Mat mat, int i, int i2, MatOfFloat matOfFloat) {
        fastNlMeansDenoisingMulti_3(Converters.vector_Mat_to_Mat(list).nativeObj, mat.nativeObj, i, i2, ((Mat) matOfFloat).nativeObj);
    }
