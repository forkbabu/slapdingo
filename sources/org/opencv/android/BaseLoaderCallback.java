    ...
    public void onManagerConnected(int i) {
        ...
        if (i == 2) {
            ...
            create.setButton(-1, "OK", new DialogInterface.OnClickListener() {
                /* class org.opencv.android.BaseLoaderCallback.AnonymousClass1 */
            ...
            create2.setButton(-1, "OK", new DialogInterface.OnClickListener() {
                /* class org.opencv.android.BaseLoaderCallback.AnonymousClass3 */
            ...
            create3.setButton(-1, "OK", new DialogInterface.OnClickListener() {
                /* class org.opencv.android.BaseLoaderCallback.AnonymousClass2 */
    ...
    public void onPackageInstall(int i, final InstallCallbackInterface installCallbackInterface) {
        if (i == 0) {
            ...
            create.setButton(-1, "Yes", new DialogInterface.OnClickListener() {
                /* class org.opencv.android.BaseLoaderCallback.AnonymousClass4 */
            ...
            create.setButton(-2, "No", new DialogInterface.OnClickListener() {
                /* class org.opencv.android.BaseLoaderCallback.AnonymousClass5 */
            ...
            create2.setButton(-1, "Wait", new DialogInterface.OnClickListener() {
                /* class org.opencv.android.BaseLoaderCallback.AnonymousClass6 */
            ...
            create2.setButton(-2, "Exit", new DialogInterface.OnClickListener() {
                /* class org.opencv.android.BaseLoaderCallback.AnonymousClass7 */
