...
public class Net {
    ...
    public long getFLOPS(MatOfInt matOfInt) {
        return getFLOPS_0(this.nativeObj, ((Mat) matOfInt).nativeObj);
    }

    public long getFLOPS(int i, MatOfInt matOfInt) {
        return getFLOPS_1(this.nativeObj, i, ((Mat) matOfInt).nativeObj);
    }
    ...
    public long getPerfProfile(MatOfDouble matOfDouble) {
        return getPerfProfile_0(this.nativeObj, ((Mat) matOfDouble).nativeObj);
    }
    ...
    public void getMemoryConsumption(MatOfInt matOfInt, long[] jArr, long[] jArr2) {
        ...
        getMemoryConsumption_0(this.nativeObj, ((Mat) matOfInt).nativeObj, dArr, dArr2);
        if (jArr != null) {
            jArr[0] = (long) dArr[0];
        }
        if (jArr2 != null) {
    ...
    public void getMemoryConsumption(int i, MatOfInt matOfInt, long[] jArr, long[] jArr2) {
        double[] dArr = new double[1];
        double[] dArr2 = new double[1];
        getMemoryConsumption_1(this.nativeObj, i, ((Mat) matOfInt).nativeObj, dArr, dArr2);
        if (jArr != null) {
            jArr[0] = (long) dArr[0];
        }
        if (jArr2 != null) {
