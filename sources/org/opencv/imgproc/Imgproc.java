...
public class Imgproc {
    ...
    public static Mat getAffineTransform(MatOfPoint2f matOfPoint2f, MatOfPoint2f matOfPoint2f2) {
        return new Mat(getAffineTransform_0(((Mat) matOfPoint2f).nativeObj, ((Mat) matOfPoint2f2).nativeObj));
    }
    ...
    public static Rect boundingRect(MatOfPoint matOfPoint) {
        return new Rect(boundingRect_0(((Mat) matOfPoint).nativeObj));
    }

    public static RotatedRect fitEllipse(MatOfPoint2f matOfPoint2f) {
        return new RotatedRect(fitEllipse_0(((Mat) matOfPoint2f).nativeObj));
    }
    ...
    public static RotatedRect minAreaRect(MatOfPoint2f matOfPoint2f) {
        return new RotatedRect(minAreaRect_0(((Mat) matOfPoint2f).nativeObj));
    }
    ...
    public static boolean isContourConvex(MatOfPoint matOfPoint) {
        return isContourConvex_0(((Mat) matOfPoint).nativeObj);
    }

    public static double arcLength(MatOfPoint2f matOfPoint2f, boolean z) {
        return arcLength_0(((Mat) matOfPoint2f).nativeObj, z);
    }
    ...
    public static double pointPolygonTest(MatOfPoint2f matOfPoint2f, Point point, boolean z) {
        return pointPolygonTest_0(((Mat) matOfPoint2f).nativeObj, point.x, point.y, z);
    }
    ...
    public static void approxPolyDP(MatOfPoint2f matOfPoint2f, MatOfPoint2f matOfPoint2f2, double d, boolean z) {
        approxPolyDP_0(((Mat) matOfPoint2f).nativeObj, ((Mat) matOfPoint2f2).nativeObj, d, z);
    }
    ...
    public static void calcBackProject(List<Mat> list, MatOfInt matOfInt, Mat mat, Mat mat2, MatOfFloat matOfFloat, double d) {
        calcBackProject_0(Converters.vector_Mat_to_Mat(list).nativeObj, ((Mat) matOfInt).nativeObj, mat.nativeObj, mat2.nativeObj, ((Mat) matOfFloat).nativeObj, d);
    }
    ...
    public static void calcHist(List<Mat> list, MatOfInt matOfInt, Mat mat, Mat mat2, MatOfInt matOfInt2, MatOfFloat matOfFloat, boolean z) {
        calcHist_0(Converters.vector_Mat_to_Mat(list).nativeObj, ((Mat) matOfInt).nativeObj, mat.nativeObj, mat2.nativeObj, ((Mat) matOfInt2).nativeObj, ((Mat) matOfFloat).nativeObj, z);
    }

    public static void calcHist(List<Mat> list, MatOfInt matOfInt, Mat mat, Mat mat2, MatOfInt matOfInt2, MatOfFloat matOfFloat) {
        calcHist_1(Converters.vector_Mat_to_Mat(list).nativeObj, ((Mat) matOfInt).nativeObj, mat.nativeObj, mat2.nativeObj, ((Mat) matOfInt2).nativeObj, ((Mat) matOfFloat).nativeObj);
    }
    ...
    public static void convexHull(MatOfPoint matOfPoint, MatOfInt matOfInt, boolean z) {
        convexHull_0(((Mat) matOfPoint).nativeObj, ((Mat) matOfInt).nativeObj, z);
    }

    public static void convexHull(MatOfPoint matOfPoint, MatOfInt matOfInt) {
        convexHull_1(((Mat) matOfPoint).nativeObj, ((Mat) matOfInt).nativeObj);
    }

    public static void convexityDefects(MatOfPoint matOfPoint, MatOfInt matOfInt, MatOfInt4 matOfInt4) {
        convexityDefects_0(((Mat) matOfPoint).nativeObj, ((Mat) matOfInt).nativeObj, ((Mat) matOfInt4).nativeObj);
    }
    ...
    public static void ellipse2Poly(Point point, Size size, int i, int i2, int i3, int i4, MatOfPoint matOfPoint) {
        ellipse2Poly_0(point.x, point.y, size.width, size.height, i, i2, i3, i4, ((Mat) matOfPoint).nativeObj);
    }
    ...
    public static void fillConvexPoly(Mat mat, MatOfPoint matOfPoint, Scalar scalar, int i, int i2) {
        fillConvexPoly_0(mat.nativeObj, ((Mat) matOfPoint).nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], i, i2);
    }

    public static void fillConvexPoly(Mat mat, MatOfPoint matOfPoint, Scalar scalar) {
        fillConvexPoly_1(mat.nativeObj, ((Mat) matOfPoint).nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3]);
    }
    ...
    public static void goodFeaturesToTrack(Mat mat, MatOfPoint matOfPoint, int i, double d, double d2, Mat mat2, int i2, int i3, boolean z, double d3) {
        goodFeaturesToTrack_0(mat.nativeObj, ((Mat) matOfPoint).nativeObj, i, d, d2, mat2.nativeObj, i2, i3, z, d3);
    }

    public static void goodFeaturesToTrack(Mat mat, MatOfPoint matOfPoint, int i, double d, double d2, Mat mat2, int i2, int i3) {
        goodFeaturesToTrack_1(mat.nativeObj, ((Mat) matOfPoint).nativeObj, i, d, d2, mat2.nativeObj, i2, i3);
    }
    ...
    public static void goodFeaturesToTrack(Mat mat, MatOfPoint matOfPoint, int i, double d, double d2, Mat mat2, int i2, boolean z, double d3) {
        goodFeaturesToTrack_2(mat.nativeObj, ((Mat) matOfPoint).nativeObj, i, d, d2, mat2.nativeObj, i2, z, d3);
    }

    public static void goodFeaturesToTrack(Mat mat, MatOfPoint matOfPoint, int i, double d, double d2) {
        goodFeaturesToTrack_3(mat.nativeObj, ((Mat) matOfPoint).nativeObj, i, d, d2);
    }
    ...
    public static void minEnclosingCircle(MatOfPoint2f matOfPoint2f, Point point, float[] fArr) {
        double[] dArr = new double[2];
        double[] dArr2 = new double[1];
        minEnclosingCircle_0(((Mat) matOfPoint2f).nativeObj, dArr, dArr2);
        if (point != null) {
            point.x = dArr[0];
            point.y = dArr[1];
        }
