...
public class Moments {
    ...
    public void completeState() {
        ...
        this.mu11 = d9;
        this.mu02 = d12;
        this.mu30 = this.m30 - (((d8 * 3.0d) + (d3 * d7)) * d3);
        double d13 = d9 + d9;
        this.mu21 = (this.m21 - ((d13 + (d3 * d11)) * d3)) - (d8 * d);
        this.mu12 = (this.m12 - ((d13 + (d7 * d)) * d)) - (d3 * d12);
        this.mu03 = this.m03 - (d * ((d12 * 3.0d) + (d11 * d)));
        double d14 = d2 * d2;
        double sqrt = Math.sqrt(Math.abs(d2)) * d14;
        this.nu20 = this.mu20 * d14;
        this.nu11 = this.mu11 * d14;
        this.nu02 = this.mu02 * d14;
