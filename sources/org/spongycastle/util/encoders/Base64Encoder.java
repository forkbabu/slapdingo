...
public class Base64Encoder implements Encoder {
    ...
    public int encode(byte[] bArr, int i, int i2, OutputStream outputStream) throws IOException {
        ...
        while (true) {
            ...
            byte b = bArr[i7] & UByte.MAX_VALUE;
            byte b2 = bArr[i7 + 1] & UByte.MAX_VALUE;
            byte b3 = bArr[i7 + 2] & UByte.MAX_VALUE;
        ...
        if (i5 == 1) {
            ...
            byte b5 = bArr[i3] & UByte.MAX_VALUE;
            byte b6 = bArr[i3 + 1] & UByte.MAX_VALUE;
