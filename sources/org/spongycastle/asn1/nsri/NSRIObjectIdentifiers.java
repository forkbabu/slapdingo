...
public interface NSRIObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_aria128_cbc = id_sea.branch(ExifInterface.GPS_MEASUREMENT_2D);
    public static final ASN1ObjectIdentifier id_aria128_ccm = id_sea.branch("37");
    public static final ASN1ObjectIdentifier id_aria128_cfb = id_sea.branch(ExifInterface.GPS_MEASUREMENT_3D);
    ...
    public static final ASN1ObjectIdentifier id_pad = id_algorithm.branch(ExifInterface.GPS_MEASUREMENT_2D);
