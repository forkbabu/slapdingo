...
public interface GMObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier sm2encrypt_specifiedParameters = sm2encrypt.branch(ExifInterface.GPS_MEASUREMENT_2D);
    ...
    public static final ASN1ObjectIdentifier sm2encrypt_with_sha256 = sm2encrypt.branch(BuildConfig.VERSION_NAME);
    ...
    static {
        ...
        sm3 = branch;
        hmac_sm3 = branch.branch(ExifInterface.GPS_MEASUREMENT_2D);
    }
}
