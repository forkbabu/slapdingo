...
public class CMCFailInfo extends ASN1Object {
    ...
    static {
        ...
        map.put(cMCFailInfo2.value, cMCFailInfo2);
        Map map2 = range;
        CMCFailInfo cMCFailInfo3 = badRequest;
        map2.put(cMCFailInfo3.value, cMCFailInfo3);
        Map map3 = range;
        CMCFailInfo cMCFailInfo4 = badTime;
        map3.put(cMCFailInfo4.value, cMCFailInfo4);
        Map map4 = range;
        CMCFailInfo cMCFailInfo5 = badCertId;
        map4.put(cMCFailInfo5.value, cMCFailInfo5);
        Map map5 = range;
        CMCFailInfo cMCFailInfo6 = popRequired;
        map5.put(cMCFailInfo6.value, cMCFailInfo6);
        Map map6 = range;
        CMCFailInfo cMCFailInfo7 = unsupportedExt;
        map6.put(cMCFailInfo7.value, cMCFailInfo7);
        Map map7 = range;
        CMCFailInfo cMCFailInfo8 = mustArchiveKeys;
        map7.put(cMCFailInfo8.value, cMCFailInfo8);
        Map map8 = range;
        CMCFailInfo cMCFailInfo9 = badIdentity;
        map8.put(cMCFailInfo9.value, cMCFailInfo9);
        Map map9 = range;
        CMCFailInfo cMCFailInfo10 = popRequired;
        map9.put(cMCFailInfo10.value, cMCFailInfo10);
        Map map10 = range;
        CMCFailInfo cMCFailInfo11 = popFailed;
        map10.put(cMCFailInfo11.value, cMCFailInfo11);
        Map map11 = range;
        CMCFailInfo cMCFailInfo12 = badCertId;
        map11.put(cMCFailInfo12.value, cMCFailInfo12);
        Map map12 = range;
        CMCFailInfo cMCFailInfo13 = popRequired;
        map12.put(cMCFailInfo13.value, cMCFailInfo13);
        Map map13 = range;
        CMCFailInfo cMCFailInfo14 = noKeyReuse;
        map13.put(cMCFailInfo14.value, cMCFailInfo14);
        Map map14 = range;
        CMCFailInfo cMCFailInfo15 = internalCAError;
        map14.put(cMCFailInfo15.value, cMCFailInfo15);
        Map map15 = range;
        CMCFailInfo cMCFailInfo16 = tryLater;
        map15.put(cMCFailInfo16.value, cMCFailInfo16);
        Map map16 = range;
        CMCFailInfo cMCFailInfo17 = authDataFail;
        map16.put(cMCFailInfo17.value, cMCFailInfo17);
    }
