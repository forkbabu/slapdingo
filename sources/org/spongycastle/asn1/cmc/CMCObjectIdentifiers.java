...
public interface CMCObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_cct_PKIData = id_cct.branch(ExifInterface.GPS_MEASUREMENT_2D);
    public static final ASN1ObjectIdentifier id_cct_PKIResponse = id_cct.branch(ExifInterface.GPS_MEASUREMENT_3D);
    ...
    public static final ASN1ObjectIdentifier id_cmc_identification = id_cmc.branch(ExifInterface.GPS_MEASUREMENT_2D);
    public static final ASN1ObjectIdentifier id_cmc_identityProof = id_cmc.branch(ExifInterface.GPS_MEASUREMENT_3D);
