...
public class SECNamedCurves {
    ...
    static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf2 = BigInteger.valueOf(1);
            ECCurve access$200 = SECNamedCurves.configureCurveGLV(new ECCurve.Fp(access$000, bigInteger, valueOf, access$0002, valueOf2), new GLVTypeBParameters(new BigInteger("7ae96a2b657c07106e64479eac3434e99cf0497512f58995c1396c28719501ee", 16), new BigInteger("5363ad4cc05c30e0a5261c028812645a122e22ea20816678df02967c1b23bd72", 16), new BigInteger[]{new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16), new BigInteger("-e4437ed6010e88286f547fa90abfe4c3", 16)}, new BigInteger[]{new BigInteger("114ca50f7a8e2f3f657c1108d9d44cfd8", 16), new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16)}, new BigInteger("3086d221a7d46bcde86c90e49284eb153dab", 16), new BigInteger("e4437ed6010e88286f547fa90abfe4c42212", 16), TIFFConstants.TIFFTAG_MODEL));
    ...
    static X9ECParametersHolder sect131r1 = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            BigInteger valueOf = BigInteger.valueOf(2);
            ECCurve access$100 = SECNamedCurves.configureCurve(new ECCurve.F2m((int) Imgproc.COLOR_RGB2YUV_YV12, 2, 3, 8, access$000, access$0002, access$0003, valueOf));
