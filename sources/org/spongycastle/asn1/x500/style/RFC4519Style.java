...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    static {
        ...
        DefaultSymbols.put(dc, DublinCoreSchema.DEFAULT_XPATH_ID);
        DefaultSymbols.put(description, DublinCoreProperties.DESCRIPTION);
        ...
        DefaultLookUp.put(DublinCoreSchema.DEFAULT_XPATH_ID, dc);
        DefaultLookUp.put(DublinCoreProperties.DESCRIPTION, description);
