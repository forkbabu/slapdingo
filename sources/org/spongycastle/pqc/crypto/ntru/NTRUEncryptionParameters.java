...
public class NTRUEncryptionParameters implements Cloneable {
    ...
    public NTRUEncryptionParameters(InputStream inputStream) throws IOException {
        ...
        if (DigestAlgorithms.SHA512.equals(readUTF)) {
    ...
    public int hashCode() {
        int i = 1231;
        int i2 = (((((((((((((((((((((((((((((((this.N + 31) * 31) + this.bufferLenBits) * 31) + this.bufferLenTrits) * 31) + this.c) * 31) + this.db) * 31) + this.df) * 31) + this.df1) * 31) + this.df2) * 31) + this.df3) * 31) + this.dg) * 31) + this.dm0) * 31) + this.dr) * 31) + this.dr1) * 31) + this.dr2) * 31) + this.dr3) * 31) + (this.fastFp ? 1231 : 1237)) * 31;
