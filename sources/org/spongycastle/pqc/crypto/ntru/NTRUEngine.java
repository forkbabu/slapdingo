    ...
    private byte[] encrypt(byte[] bArr, NTRUEncryptionPublicKeyParameters nTRUEncryptionPublicKeyParameters) {
        ...
        if (i3 > 255) {
            ...
            while (true) {
                ...
                System.arraycopy(new byte[i10], 0, bArr5, i11 + bArr2.length, i10);
                IntegerPolynomial fromBinary3Sves = IntegerPolynomial.fromBinary3Sves(bArr5, i);
                IntegerPolynomial mult = generateBlindingPoly(buildSData(bArr3, bArr, length, bArr4, copyOf(integerPolynomial.toBinary(i2), i7 / 8)), bArr5).mult(integerPolynomial, i2);
