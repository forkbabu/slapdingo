...
public class Layer {
    ...
    public Layer(int i, int i2, SecureRandom secureRandom) {
        ...
        iArr[1] = i3;
        iArr[0] = i3;
        this.coeff_alpha = (short[][][]) Array.newInstance(short.class, iArr);
        int i4 = this.oi;
        int i5 = this.vi;
        int[] iArr2 = new int[3];
        iArr2[2] = i5;
        iArr2[1] = i5;
        iArr2[0] = i4;
        this.coeff_beta = (short[][][]) Array.newInstance(short.class, iArr2);
        int i6 = this.oi;
        int[] iArr3 = new int[2];
        iArr3[1] = this.viNext;
        iArr3[0] = i6;
        this.coeff_gamma = (short[][]) Array.newInstance(short.class, iArr3);
        int i7 = this.oi;
