    ...
    private XMSSPrivateKeyParameters(Builder builder) {
        ...
        if (access$000 != null) {
            ...
            if (access$100 == null) {
                ...
                } else if (builder.index >= (1 << this.params.getHeight()) - 2 || access$500 == null || access$300 == null) {
                    this.bdsState = new BDS(this.params, builder.index);
                } else {
                    this.bdsState = new BDS(this.params, access$500, access$300, (OTSHashAddress) new OTSHashAddress.Builder().build(), builder.index);
                }
