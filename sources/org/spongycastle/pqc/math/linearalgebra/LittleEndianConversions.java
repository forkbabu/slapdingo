...
public final class LittleEndianConversions {
    ...
    public static int OS2IP(byte[] bArr, int i) {
        ...
        return ((bArr[i3 + 1] & UByte.MAX_VALUE) << 24) | b | ((bArr[i3] & UByte.MAX_VALUE) << 16);
    }
    ...
    public static long OS2LIP(byte[] bArr, int i) {
        ...
        int i4 = i3 + 1;
        int i5 = i4 + 1;
        long j2 = j | ((long) ((bArr[i2] & UByte.MAX_VALUE) << 8)) | ((long) ((bArr[i3] & UByte.MAX_VALUE) << 16)) | ((((long) bArr[i4]) & 255) << 24);
        int i6 = i5 + 1;
        int i7 = i6 + 1;
