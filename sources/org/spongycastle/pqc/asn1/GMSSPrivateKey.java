    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        while (i6 < treehashArr3.length) {
            ...
            while (i7 < treehashArr3[i6].length) {
                ...
                aSN1EncodableVector13.add(new ASN1Integer((long) treehashArr3[i6][i7].getStatInt()[0]));
                aSN1EncodableVector13.add(new ASN1Integer((long) i8));
                aSN1EncodableVector13.add(new ASN1Integer((long) treehashArr3[i6][i7].getStatInt()[2]));
                aSN1EncodableVector13.add(new ASN1Integer((long) treehashArr3[i6][i7].getStatInt()[3]));
                aSN1EncodableVector13.add(new ASN1Integer((long) treehashArr3[i6][i7].getStatInt()[4]));
                aSN1EncodableVector13.add(new ASN1Integer((long) treehashArr3[i6][i7].getStatInt()[5]));
                int i10 = 0;
                while (i10 < i8) {
                    aSN1EncodableVector13.add(new ASN1Integer((long) treehashArr3[i6][i7].getStatInt()[i10 + 6]));
                    i10++;
        ...
        for (int i31 : iArr2) {
            aSN1EncodableVector44.add(new ASN1Integer((long) i31));
        }
        ...
        while (i32 < gMSSRootCalcArr.length) {
            ...
            aSN1EncodableVector49.add(new ASN1Integer((long) i33));
            aSN1EncodableVector49.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getStatInt()[1]));
            aSN1EncodableVector49.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getStatInt()[2]));
            aSN1EncodableVector49.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getStatInt()[3]));
            aSN1EncodableVector49.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getStatInt()[4]));
            aSN1EncodableVector49.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getStatInt()[5]));
            aSN1EncodableVector49.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getStatInt()[6]));
            aSN1EncodableVector49.add(new ASN1Integer((long) i34));
            for (int i37 = 0; i37 < i33; i37++) {
                aSN1EncodableVector49.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getStatInt()[i37 + 8]));
            }
            for (int i38 = 0; i38 < i34; i38++) {
                aSN1EncodableVector49.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getStatInt()[i33 + 8 + i38]));
            }
            ...
            if (gMSSRootCalcArr[i32].getTreehash() != null) {
                ...
                while (i39 < gMSSRootCalcArr[i32].getTreehash().length) {
                    ...
                    ASN1EncodableVector aSN1EncodableVector57 = aSN1EncodableVector43;
                    aSN1EncodableVector56.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[0]));
                    aSN1EncodableVector56.add(new ASN1Integer((long) i40));
                    aSN1EncodableVector56.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[2]));
                    aSN1EncodableVector56.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[3]));
                    aSN1EncodableVector56.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[4]));
                    aSN1EncodableVector56.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[5]));
                    int i42 = 0;
                    while (i42 < i40) {
                        aSN1EncodableVector56.add(new ASN1Integer((long) gMSSRootCalcArr[i32].getTreehash()[i39].getStatInt()[i42 + 6]));
                        i42++;
                        i40 = i40;
                        aSN1EncodableVector57 = aSN1EncodableVector57;
                    }
                    ...
                    aSN1EncodableVector53 = aSN1EncodableVector53;
                    aSN1EncodableVector43 = aSN1EncodableVector57;
                }
            }
            ...
            if (gMSSRootCalcArr[i32].getRetain() != null) {
                for (int i43 = 0; i43 < gMSSRootCalcArr[i32].getRetain().length; i43++) {
                    for (int i44 = 0; i44 < gMSSRootCalcArr[i32].getRetain()[i43].size(); i44++) {
                        aSN1EncodableVector58.add(new DEROctetString((byte[]) gMSSRootCalcArr[i32].getRetain()[i43].elementAt(i44)));
                    }
                    aSN1EncodableVector51.add(new DERSequence(aSN1EncodableVector58));
        ...
        for (byte[] bArr11 : bArr7) {
            aSN1EncodableVector59.add(new DEROctetString(bArr11));
        }
        ...
        for (int i45 = 0; i45 < gMSSRootSigArr.length; i45++) {
            ...
            new ASN1EncodableVector();
            aSN1EncodableVector62.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[0]));
            aSN1EncodableVector62.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[1]));
            aSN1EncodableVector62.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[2]));
            aSN1EncodableVector62.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[3]));
            aSN1EncodableVector62.add(new DEROctetString(gMSSRootSigArr[i45].getStatByte()[4]));
            aSN1EncodableVector61.add(new DERSequence(aSN1EncodableVector62));
            aSN1EncodableVector62 = new ASN1EncodableVector();
            aSN1EncodableVector63.add(new ASN1Integer((long) gMSSRootSigArr[i45].getStatInt()[0]));
            aSN1EncodableVector63.add(new ASN1Integer((long) gMSSRootSigArr[i45].getStatInt()[1]));
            aSN1EncodableVector63.add(new ASN1Integer((long) gMSSRootSigArr[i45].getStatInt()[2]));
            aSN1EncodableVector63.add(new ASN1Integer((long) gMSSRootSigArr[i45].getStatInt()[3]));
            aSN1EncodableVector63.add(new ASN1Integer((long) gMSSRootSigArr[i45].getStatInt()[4]));
            aSN1EncodableVector63.add(new ASN1Integer((long) gMSSRootSigArr[i45].getStatInt()[5]));
            aSN1EncodableVector63.add(new ASN1Integer((long) gMSSRootSigArr[i45].getStatInt()[6]));
            aSN1EncodableVector63.add(new ASN1Integer((long) gMSSRootSigArr[i45].getStatInt()[7]));
            aSN1EncodableVector63.add(new ASN1Integer((long) gMSSRootSigArr[i45].getStatInt()[8]));
            aSN1EncodableVector61.add(new DERSequence(aSN1EncodableVector63));
        ...
        aSN1EncodableVector43.add(new DERSequence(aSN1EncodableVector60));
        ...
        for (int i46 = 0; i46 < gMSSParameters.getHeightOfTrees().length; i46++) {
            aSN1EncodableVector65.add(new ASN1Integer((long) gMSSParameters.getHeightOfTrees()[i46]));
            aSN1EncodableVector66.add(new ASN1Integer((long) gMSSParameters.getWinternitzParameter()[i46]));
            aSN1EncodableVector67.add(new ASN1Integer((long) gMSSParameters.getK()[i46]));
        }
        aSN1EncodableVector64.add(new ASN1Integer((long) gMSSParameters.getNumOfLayers()));
        ...
        aSN1EncodableVector43.add(new DERSequence(aSN1EncodableVector64));
        ...
        for (AlgorithmIdentifier algorithmIdentifier : algorithmIdentifierArr) {
            aSN1EncodableVector68.add(algorithmIdentifier);
        }
        aSN1EncodableVector43.add(new DERSequence(aSN1EncodableVector68));
