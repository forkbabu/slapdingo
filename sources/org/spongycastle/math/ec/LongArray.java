...
class LongArray implements Cloneable {
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        for (int i12 = 56; i12 >= 0; i12 -= 8) {
            for (int i13 = 1; i13 < i5; i13 += 2) {
                ...
                addBoth(jArr6, i13 - 1, jArr3, iArr2[i14 & 15], jArr4, iArr2[(i14 >>> 4) & 15], i8);
            }
            shiftUp(jArr6, 0, i7, 8);
        }
        for (int i15 = 56; i15 >= 0; i15 -= 8) {
            for (int i16 = 0; i16 < i5; i16 += 2) {
                int i17 = (int) (jArr5[i16] >>> i15);
                addBoth(jArr6, i16, jArr3, iArr2[i17 & 15], jArr4, iArr2[(i17 >>> 4) & 15], i8);
            }
            if (i15 > 0) {
                shiftUp(jArr6, 0, i7, 8);
            }
        }
        return reduceResult(jArr6, 0, i7, i, iArr);
    }
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        while (i14 < i5) {
            ...
            while (true) {
                long j3 = j2 >>> 4;
                addBoth(jArr6, i15, jArr3, iArr2[((int) j2) & 15], jArr4, iArr2[((int) j3) & 15], i8);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            ...
            addShiftedUp(jArr6, i13 - i7, jArr6, i13, i7, 8);
        }
    }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        int i14 = i11;
        interleave(longArray3.m_ints, 0, jArr2, 0, i6, 4);
        System.arraycopy(longArray2.m_ints, 0, jArr2, i6, i7);
        int i15 = i6;
        int i16 = 1;
        while (i16 < 8) {
            int i17 = i15 + i10;
    ...
    public LongArray multiply(LongArray longArray, int i, int[] iArr) {
        ...
        while (true) {
            i13 -= i7;
            if (i13 == 0) {
                return new LongArray(jArr6, 0, i7);
            }
            addShiftedUp(jArr6, i13 - i7, jArr6, i13, i7, 8);
        }
    }
