...
public class CamelliaLightEngine implements BlockCipher {
    ...
    private static final byte[] SBOX1 = {112, -126, 44, -20, -77, 39, -64, -27, -28, -123, 87, 53, -22, BidiOrder.CS, -82, 65, 35, -17, 107, -109, 69, 25, -91, 33, -19, BidiOrder.BN, 79, 78, 29, 101, -110, -67, -122, -72, -81, -113, 124, -21, 31, -50, DocWriter.GT, ByteBuffer.ZERO, -36, 95, 94, -59, BidiOrder.AN, 26, -90, -31, 57, -54, -43, 71, 93, DocWriter.EQUALS, -39, 1, 90, -42, 81, 86, 108, 77, -117, BidiOrder.NSM, -102, 102, -5, -52, -80, 45, 116, 18, 43, DocWriter.SPACE, -16, -79, -124, -103, -33, 76, -53, -62, 52, 126, 118, 5, 109, -73, -87, 49, -47, 23, 4, -41, 20, 88, 58, 97, -34, 27, BidiOrder.WS, 28, 50, BidiOrder.B, -100, 22, 83, 24, -14, DocWriter.QUOTE, -2, 68, -49, -78, -61, -75, 122, -111, 36, 8, -24, -88, 96, -4, 105, 80, -86, -48, -96, 125, -95, -119, 98, -105, 84, 91, 30, -107, -32, -1, 100, -46, 16, -60, 0, 72, -93, -9, 117, -37, -118, 3, -26, -38, 9, 63, -35, -108, -121, 92, -125, 2, -51, 74, -112, 51, 115, 103, -10, -13, -99, ByteCompanionObject.MAX_VALUE, -65, -30, 82, -101, -40, 38, -56, 55, -58, 59, -127, -106, 111, 75, 19, -66, 99, 46, -23, 121, -89, -116, -97, 110, PSSSigner.TRAILER_IMPLICIT, -114, 41, -11, -7, -74, DocWriter.FORWARD, -3, -76, 89, 120, -104, 6, 106, -25, 70, 113, -70, -44, 37, -85, 66, -120, -94, -115, -6, 114, 7, -71, 85, -8, -18, -84, 10, 54, 73, 42, 104, DocWriter.LT, 56, -15, -92, 64, 40, -45, 123, -69, -55, 67, -63, 21, -29, -83, -12, 119, -57, ByteCompanionObject.MIN_VALUE, -98};
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        int leftRotate = leftRotate((bArr[i3 & 255] & UByte.MAX_VALUE) | (sbox4((i3 >>> 8) & 255) << 8) | (sbox3((i3 >>> 16) & 255) << 16) | (sbox2((i3 >>> 24) & 255) << 24), 8);
        ...
        byte[] bArr2 = SBOX1;
        int i6 = ((bArr2[(i5 >>> 24) & 255] & UByte.MAX_VALUE) << 24) | sbox42;
        int i7 = iArr2[i + 3] ^ iArr[3];
        int leftRotate3 = leftRotate((sbox2((i7 >>> 24) & 255) << 24) | (bArr2[i7 & 255] & UByte.MAX_VALUE) | (sbox4((i7 >>> 8) & 255) << 8) | (sbox3((i7 >>> 16) & 255) << 16), 8);
