...
class Utils {
    ...
    static {
        ...
        hashtable.put(DigestAlgorithms.SHA1, Integers.valueOf(128));
        maxSecurityStrengths.put("SHA-224", Integers.valueOf(192));
        maxSecurityStrengths.put("SHA-256", Integers.valueOf(256));
        maxSecurityStrengths.put(DigestAlgorithms.SHA384, Integers.valueOf(256));
        maxSecurityStrengths.put(DigestAlgorithms.SHA512, Integers.valueOf(256));
    ...
    static int getMaxSecurityStrength(Mac mac) {
        ...
        return ((Integer) maxSecurityStrengths.get(algorithmName.substring(0, algorithmName.indexOf(Constants.PATH_SEPERATOR)))).intValue();
    }
