...
public class HMac implements Mac {
    ...
    static {
        ...
        blockLengths.put(DigestAlgorithms.SHA1, Integers.valueOf(64));
        blockLengths.put("SHA-224", Integers.valueOf(64));
        blockLengths.put("SHA-256", Integers.valueOf(64));
        blockLengths.put(DigestAlgorithms.SHA384, Integers.valueOf(128));
        blockLengths.put(DigestAlgorithms.SHA512, Integers.valueOf(128));
