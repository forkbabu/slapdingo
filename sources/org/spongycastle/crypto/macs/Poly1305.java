...
public class Poly1305 implements Mac {
    ...
    private void processBlock() {
        ...
        int i3 = (int) (((long) this.h4) + (littleEndianToInt4 >>> 8));
        this.h4 = i3;
        if (this.currentBlockOffset == 16) {
            this.h4 = i3 + 16777216;
        }
    ...
    public int doFinal(byte[] bArr, int i) throws DataLengthException, IllegalStateException {
        if (i + 16 <= bArr.length) {
            ...
            Pack.intToLittleEndian((int) ((((long) ((i27 >>> 18) | (i28 << 8))) & BodyPartID.bodyIdMax) + (BodyPartID.bodyIdMax & ((long) this.k3)) + (j5 >>> 32)), bArr, i + 12);
            reset();
            return 16;
        }
