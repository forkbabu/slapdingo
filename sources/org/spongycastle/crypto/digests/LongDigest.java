...
public abstract class LongDigest implements ExtendedDigest, Memoable, EncodableDigest {
    ...
    public void processBlock() {
        ...
        while (i3 < 10) {
            int i4 = i2 + 1;
            long Sum1 = j13 + Sum1(j12) + Ch(j12, j8, j15) + K[i2] + this.W[i2];
            long j16 = j9 + Sum1;
            long Sum0 = Sum1 + Sum0(j14) + Maj(j14, j10, j11);
            int i5 = i4 + 1;
            long Sum12 = j15 + Sum1(j16) + Ch(j16, j12, j8) + K[i4] + this.W[i4];
            long j17 = j11 + Sum12;
            long Sum02 = Sum12 + Sum0(Sum0) + Maj(Sum0, j14, j10);
            int i6 = i5 + 1;
            long Sum13 = j8 + Sum1(j17) + Ch(j17, j16, j12) + K[i5] + this.W[i5];
            long j18 = j10 + Sum13;
            long Sum03 = Sum13 + Sum0(Sum02) + Maj(Sum02, Sum0, j14);
            int i7 = i6 + 1;
            long Sum14 = j12 + Sum1(j18) + Ch(j18, j17, j16) + K[i6] + this.W[i6];
            long j19 = j14 + Sum14;
            ...
            long Sum18 = j19 + Sum1(j22) + Ch(j22, j15, j20) + K[i10] + this.W[i10];
