...
public abstract class Evaluator {
    ...
    public static final class Id extends Evaluator {
        ...
        @Override // org.jsoup.select.Evaluator
        public boolean matches(Element element, Element element2) {
            return this.f66id.equals(element2.id());
        }

        public String toString() {
            return String.format("#%s", this.f66id);
        }
    }
    ...
    public static class IsNthOfType extends CssNthEvaluator {
        ...
        @Override // org.jsoup.select.Evaluator.CssNthEvaluator
        public int calculatePosition(Element element, Element element2) {
            Iterator it2 = element2.parent().children().iterator();
            int i = 0;
            while (it2.hasNext()) {
    ...
    public static final class IsOnlyOfType extends Evaluator {
        ...
        public boolean matches(Element element, Element element2) {
            ...
            Iterator it2 = parent.children().iterator();
            int i = 0;
            while (it2.hasNext()) {
                if (((Element) it2.next()).tag().equals(element2.tag())) {
                    i++;
                }
            }
            if (i == 1) {
