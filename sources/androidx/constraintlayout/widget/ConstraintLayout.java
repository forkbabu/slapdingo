...
public class ConstraintLayout extends ViewGroup {
    ...
    public void setDesignInformation(int i, Object obj, Object obj2) {
        if (i == 0 && (obj instanceof String) && (obj2 instanceof Integer)) {
            ...
            int indexOf = str.indexOf(Constants.PATH_SEPERATOR);
            if (indexOf != -1) {
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:238:0x03f0 */
    /* JADX WARN: Failed to insert an additional move for type inference into block B:232:0x03f0 */
            ...
            if (viewWidget2 != null) {
                ...
                if (layoutParams.isGuideline) {
                    ...
                    if (layoutParams.circleConstraint != -1) {
                        ...
                        } else if (!(i15 == -1 || (targetWidget3 = getTargetWidget(i15)) == null)) {
