...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f20id == -1 || solverVariable.f20id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f20id] == null) {
                if (solverVariable.f20id != -1) {
                    solverVariable.reset();
                }
                int i = this.mVariablesID + 1;
                this.mVariablesID = i;
                this.mNumColumns++;
                solverVariable.f20id = i;
