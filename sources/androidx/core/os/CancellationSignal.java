...
public final class CancellationSignal {
    ...
    public void setOnCancelListener(androidx.core.os.CancellationSignal.OnCancelListener r2) {
        /*
            r1 = this;
            monitor-enter(r1)
            r1.waitForCancelFinishedLocked()     // Catch:{ all -> 0x001a }
            androidx.core.os.CancellationSignal$OnCancelListener r0 = r1.mOnCancelListener     // Catch:{ all -> 0x001a }
            if (r0 != r2) goto L_0x000a
            monitor-exit(r1)     // Catch:{ all -> 0x001a }
            return
        L_0x000a:
            r1.mOnCancelListener = r2     // Catch:{ all -> 0x001a }
            boolean r0 = r1.mIsCanceled     // Catch:{ all -> 0x001a }
