...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0085, code lost:
        androidx.core.provider.FontsContractCompat.sBackgroundThread.postAndReply(r1, new androidx.core.provider.FontsContractCompat.AnonymousClass3());
     */
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r2, final androidx.core.provider.FontRequest r3, final androidx.core.content.res.ResourcesCompat.FontCallback r4, final android.os.Handler r5, boolean r6, int r7, final int r8) {
        /*
            ...
            androidx.collection.LruCache<java.lang.String, android.graphics.Typeface> r1 = androidx.core.provider.FontsContractCompat.sTypefaceCache
        ...
        L_0x0045:
            ...
            androidx.core.provider.SelfDestructiveThread r3 = androidx.core.provider.FontsContractCompat.sBackgroundThread     // Catch:{ InterruptedException -> 0x0057 }
        ...
        L_0x005c:
            ...
            r3.<init>(r5)
        L_0x0061:
            java.lang.Object r4 = androidx.core.provider.FontsContractCompat.sLock
            monitor-enter(r4)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r5 = androidx.core.provider.FontsContractCompat.sPendingReplies     // Catch:{ all -> 0x0090 }
        ...
        L_0x0075:
            ...
            r5.add(r3)     // Catch:{ all -> 0x0090 }
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r3 = androidx.core.provider.FontsContractCompat.sPendingReplies     // Catch:{ all -> 0x0090 }
            r3.put(r0, r5)     // Catch:{ all -> 0x0090 }
        L_0x0084:
            monitor-exit(r4)     // Catch:{ all -> 0x0090 }
            androidx.core.provider.SelfDestructiveThread r3 = androidx.core.provider.FontsContractCompat.sBackgroundThread
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        Uri build2 = new Uri.Builder().scheme("content").authority(str).appendPath(Annotation.FILE).build();
        Cursor cursor = null;
        try {
