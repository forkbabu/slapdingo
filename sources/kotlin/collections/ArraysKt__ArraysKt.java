...
class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
    ...
    private static final <C extends Object & R, R> R ifEmpty(C c, Function0<? extends R> function0) {
                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m423contentEqualsus8wMrg(t.m219unboximpl(), t2.m219unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m420contentEqualsctEhBpI(t.m150unboximpl(), t2.m150unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m422contentEqualsmazbYpA(t.m314unboximpl(), t2.m314unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m421contentEqualskdPth3s(t.m81unboximpl(), t2.m81unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m429contentToStringGBYM_sE(t.m81unboximpl()));
            } else if (t instanceof UShortArray) {
                sb.append(UArraysKt.m431contentToStringrL5Bavg(t.m314unboximpl()));
            } else if (t instanceof UIntArray) {
                sb.append(UArraysKt.m428contentToStringajY9A(t.m150unboximpl()));
            } else if (t instanceof ULongArray) {
                sb.append(UArraysKt.m430contentToStringQwZRm1k(t.m219unboximpl()));
            } else {
