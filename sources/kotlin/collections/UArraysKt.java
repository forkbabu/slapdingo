...
public final class UArraysKt {
    ...
    public static final int m348random2D5oskM(int[] iArr, Random random) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UIntArray.m144isEmptyimpl(iArr)) {
            return UIntArray.m141getimpl(iArr, random.nextInt(UIntArray.m142getSizeimpl(iArr)));
        }
    ...
    public static final long m349randomJzugnMA(long[] jArr, Random random) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!ULongArray.m213isEmptyimpl(jArr)) {
            return ULongArray.m210getimpl(jArr, random.nextInt(ULongArray.m211getSizeimpl(jArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final byte m350randomoSF2wD8(byte[] bArr, Random random) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UByteArray.m75isEmptyimpl(bArr)) {
            return UByteArray.m72getimpl(bArr, random.nextInt(UByteArray.m73getSizeimpl(bArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final short m351randoms5X_as8(short[] sArr, Random random) {
    ...
    public static final boolean m336contentEqualsctEhBpI(int[] iArr, int[] iArr2) {
    ...
    public static final boolean m339contentEqualsus8wMrg(long[] jArr, long[] jArr2) {
    ...
    public static final boolean m337contentEqualskdPth3s(byte[] bArr, byte[] bArr2) {
    ...
    public static final boolean m338contentEqualsmazbYpA(short[] sArr, short[] sArr2) {
    ...
    public static final int m340contentHashCodeajY9A(int[] iArr) {
    ...
    public static final int m342contentHashCodeQwZRm1k(long[] jArr) {
    ...
    public static final int m341contentHashCodeGBYM_sE(byte[] bArr) {
    ...
    public static final int m343contentHashCoderL5Bavg(short[] sArr) {
    ...
    public static final String m344contentToStringajY9A(int[] iArr) {
    ...
    public static final String m346contentToStringQwZRm1k(long[] jArr) {
    ...
    public static final String m345contentToStringGBYM_sE(byte[] bArr) {
    ...
    public static final String m347contentToStringrL5Bavg(short[] sArr) {
    ...
    public static final UInt[] m352toTypedArrayajY9A(int[] iArr) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$toTypedArray");
        int r0 = UIntArray.m142getSizeimpl(iArr);
        UInt[] uIntArr = new UInt[r0];
        for (int i = 0; i < r0; i++) {
            uIntArr[i] = UInt.m84boximpl(UIntArray.m141getimpl(iArr, i));
        }
        return uIntArr;
    }
    ...
    public static final ULong[] m354toTypedArrayQwZRm1k(long[] jArr) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$toTypedArray");
        int r0 = ULongArray.m211getSizeimpl(jArr);
        ULong[] uLongArr = new ULong[r0];
        for (int i = 0; i < r0; i++) {
            uLongArr[i] = ULong.m153boximpl(ULongArray.m210getimpl(jArr, i));
        }
        return uLongArr;
    }
    ...
    public static final UByte[] m353toTypedArrayGBYM_sE(byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$toTypedArray");
        int r0 = UByteArray.m73getSizeimpl(bArr);
        UByte[] uByteArr = new UByte[r0];
        for (int i = 0; i < r0; i++) {
            uByteArr[i] = UByte.m17boximpl(UByteArray.m72getimpl(bArr, i));
        }
        return uByteArr;
    }
    ...
    public static final UShort[] m355toTypedArrayrL5Bavg(short[] sArr) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$toTypedArray");
        int r0 = UShortArray.m306getSizeimpl(sArr);
