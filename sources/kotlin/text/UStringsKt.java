...
public final class UStringsKt {
    ...
    public static final String m952toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m954toStringolVBNx4(short s, int i) {
    ...
    public static final String m953toStringV7xB4Y4(int i, int i2) {
        String l = Long.toString(((long) i) & BodyPartID.bodyIdMax, CharsKt.checkRadix(i2));
        Intrinsics.checkExpressionValueIsNotNull(l, "java.lang.Long.toString(this, checkRadix(radix))");
        return l;
    }

    /* renamed from: toString-JSWoG40  reason: not valid java name */
    public static final String m951toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m64unboximpl();
        }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m202unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw null;
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        return UByte.m17boximpl(UByte.m23constructorimpl((byte) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m316uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m159constructorimpl((long) i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m318ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m159constructorimpl(j2 * r9);
            long r4 = ULong.m159constructorimpl(ULong.m159constructorimpl(((long) UInt.m90constructorimpl(digitOf)) & BodyPartID.bodyIdMax) + r11);
