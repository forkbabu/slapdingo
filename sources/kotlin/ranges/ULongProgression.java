...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        if (j3 == 0) {
            ...
            this.first = j;
            this.last = UProgressionUtilKt.m898getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
        } else {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + (((((int) ULong.m159constructorimpl(j ^ ULong.m159constructorimpl(j >>> 32))) * 31) + ((int) ULong.m159constructorimpl(j2 ^ ULong.m159constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sb.append(ULong.m196toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m196toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m915fromClosedRange7ftBX0g(long j, long j2, long j3) {
