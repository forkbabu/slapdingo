...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v2, resolved type: java.lang.Comparable} */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v3, resolved type: java.lang.Comparable} */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(T t, T t2, T t3) {
        ...
        if (t2 == null || t3 == null) {
            ...
            throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) t3) + " is less than minimum " + ((Object) t2) + '.');
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(T t, ClosedRange<T> closedRange) {
        ...
        if (closedRange instanceof ClosedFloatingPointRange) {
            return RangesKt.coerceIn((Comparable) t, (ClosedFloatingPointRange) closedRange);
        }
