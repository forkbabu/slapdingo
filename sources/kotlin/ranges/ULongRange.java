...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(ULong uLong) {
        return m916containsVKZWuLQ(uLong.m202unboximpl());
    }

    @Override // kotlin.ranges.ClosedRange
    public ULong getStart() {
        return ULong.m153boximpl(getFirst());
    }

    @Override // kotlin.ranges.ClosedRange
    public ULong getEndInclusive() {
        return ULong.m153boximpl(getLast());
    }

    /* renamed from: contains-VKZWuLQ  reason: not valid java name */
    public boolean m916containsVKZWuLQ(long j) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m159constructorimpl(getLast() ^ ULong.m159constructorimpl(getLast() >>> 32))) + (((int) ULong.m159constructorimpl(getFirst() ^ ULong.m159constructorimpl(getFirst() >>> 32))) * 31);
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ULong.m196toStringimpl(getFirst()) + ".." + ULong.m196toStringimpl(getLast());
    }
