...
final class AdjustedTimeMark extends TimeMark {
    ...
    public double elapsedNow() {
        return Duration.m983minusLRDsOJo(this.mark.elapsedNow(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m957plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m984plusLRDsOJo(this.adjustment, d), null);
    }
}
