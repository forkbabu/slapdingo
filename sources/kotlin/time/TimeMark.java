...
public abstract class TimeMark {
    ...
    public TimeMark m1009plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this, d, null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1008minusLRDsOJo(double d) {
        return m1009plusLRDsOJo(Duration.m1001unaryMinusimpl(d));
    }

    public final boolean hasPassedNow() {
        return !Duration.m981isNegativeimpl(elapsedNow());
    }
