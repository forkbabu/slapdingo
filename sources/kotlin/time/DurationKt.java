...
public final class DurationKt {
    ...
    private static final double m1005timesmvk6XK0(int i, double d) {
        return Duration.m987timesimpl(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m1004timeskIfJnKk(double d, double d2) {
        return Duration.m986timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkParameterIsNotNull(timeUnit, "unit");
        return Duration.m960constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
