...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
    ...
    public void setImageDrawable(final Drawable drawable, final Matrix matrix, final float f, final float f2) {
        if (getWidth() <= 0) {
            this.mLayoutRunnable = new Runnable() {
                /* class it.sephiroth.android.library.imagezoom.ImageViewTouchBase.AnonymousClass1 */
    ...
    public void scrollBy(float f, float f2, final double d) {
        ...
        this.mHandler.post(new Runnable() {
            /* class it.sephiroth.android.library.imagezoom.ImageViewTouchBase.AnonymousClass2 */
            double old_x = 0.0d;
            double old_y = 0.0d;
    ...
    public void zoomTo(float f, float f2, float f3, final float f4) {
        ...
        this.mHandler.post(new Runnable() {
            /* class it.sephiroth.android.library.imagezoom.ImageViewTouchBase.AnonymousClass3 */

            public void run() {
                float min = Math.min(f4, (float) (System.currentTimeMillis() - currentTimeMillis));
                ImageViewTouchBase.this.zoomTo(scale + ((float) ImageViewTouchBase.this.mEasing.easeInOut((double) min, 0.0d, (double) f5, (double) f4)), f6, f7);
                if (min < f4) {
                    ImageViewTouchBase.this.mHandler.post(this);
                    return;
                }
