...
public final class EasingManager {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$it$sephiroth$android$library$easing$EasingManager$EaseType;
        ...
        static {
            /*
                it.sephiroth.android.library.easing.EasingManager$EaseType[] r0 = it.sephiroth.android.library.easing.EasingManager.EaseType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                it.sephiroth.android.library.easing.EasingManager.AnonymousClass1.$SwitchMap$it$sephiroth$android$library$easing$EasingManager$EaseType = r0
                it.sephiroth.android.library.easing.EasingManager$EaseType r1 = it.sephiroth.android.library.easing.EasingManager.EaseType.EaseIn     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = it.sephiroth.android.library.easing.EasingManager.AnonymousClass1.$SwitchMap$it$sephiroth$android$library$easing$EasingManager$EaseType     // Catch:{ NoSuchFieldError -> 0x001d }
                it.sephiroth.android.library.easing.EasingManager$EaseType r1 = it.sephiroth.android.library.easing.EasingManager.EaseType.EaseInOut     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = it.sephiroth.android.library.easing.EasingManager.AnonymousClass1.$SwitchMap$it$sephiroth$android$library$easing$EasingManager$EaseType     // Catch:{ NoSuchFieldError -> 0x0028 }
                it.sephiroth.android.library.easing.EasingManager$EaseType r1 = it.sephiroth.android.library.easing.EasingManager.EaseType.EaseNone     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = it.sephiroth.android.library.easing.EasingManager.AnonymousClass1.$SwitchMap$it$sephiroth$android$library$easing$EasingManager$EaseType     // Catch:{ NoSuchFieldError -> 0x0033 }
                it.sephiroth.android.library.easing.EasingManager$EaseType r1 = it.sephiroth.android.library.easing.EasingManager.EaseType.EaseOut     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: it.sephiroth.android.library.easing.EasingManager.AnonymousClass1.<clinit>():void");
        }
    }

    /* access modifiers changed from: package-private */
    public String getMethodName(EaseType easeType) {
        int i = AnonymousClass1.$SwitchMap$it$sephiroth$android$library$easing$EasingManager$EaseType[easeType.ordinal()];
        if (i == 1) {
            return "easeIn";
        }
        if (i == 2) {
    ...
    class Ticker implements Runnable {
        ...
        public void run() {
            ...
            try {
                double doubleValue = ((Double) EasingManager.this.mMethod.invoke(EasingManager.this.mEasing, Long.valueOf(uptimeMillis), Double.valueOf(EasingManager.this.mStartValue), Double.valueOf(EasingManager.this.mEndValue), Integer.valueOf(EasingManager.this.mDuration))).doubleValue();
