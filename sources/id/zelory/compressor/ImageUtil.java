...
class ImageUtil {
    ...
    static java.io.File compressImage(java.io.File r2, int r3, int r4, android.graphics.Bitmap.CompressFormat r5, int r6, java.lang.String r7) throws java.io.IOException {
        ...
        L_0x0037:
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: id.zelory.compressor.ImageUtil.compressImage(java.io.File, int, int, android.graphics.Bitmap$CompressFormat, int, java.lang.String):java.io.File");
    }
