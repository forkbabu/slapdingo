    ...
    private void encodeQRCodeContents(String str, Bundle bundle, String str2) {
        ...
        if (c != 0) {
            if (c == 1) {
                ...
                for (int i = 0; i < QRGContents.PHONE_KEYS.length; i++) {
                    String trim6 = trim(bundle.getString(QRGContents.PHONE_KEYS[i]));
                    if (trim6 != null) {
                        hashSet.add(trim6);
                    }
                }
                ...
                for (int i2 = 0; i2 < QRGContents.EMAIL_KEYS.length; i2++) {
                    String trim7 = trim(bundle.getString(QRGContents.EMAIL_KEYS[i2]));
                    if (trim7 != null) {
                        hashSet2.add(trim7);
                    }
                }
