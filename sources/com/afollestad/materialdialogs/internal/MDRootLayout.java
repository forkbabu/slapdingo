    ...
    static /* synthetic */ class AnonymousClass4 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.afollestad.materialdialogs.internal.MDRootLayout.AnonymousClass4.$SwitchMap$com$afollestad$materialdialogs$GravityEnum = r0
            ...
            L_0x0012:
                int[] r0 = com.afollestad.materialdialogs.internal.MDRootLayout.AnonymousClass4.$SwitchMap$com$afollestad$materialdialogs$GravityEnum     // Catch:{ NoSuchFieldError -> 0x001d }
        ...
        if (view != null) {
            if (view instanceof ScrollView) {
                ...
                view.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                    /* class com.afollestad.materialdialogs.internal.MDRootLayout.AnonymousClass1 */
        ...
        if ((!z2 && this.topOnScrollChangedListener == null) || (z2 && this.bottomOnScrollChangedListener == null)) {
            if (viewGroup instanceof RecyclerView) {
                AnonymousClass2 r0 = new RecyclerView.OnScrollListener() {
                    /* class com.afollestad.materialdialogs.internal.MDRootLayout.AnonymousClass2 */
            ...
            AnonymousClass3 r02 = new ViewTreeObserver.OnScrollChangedListener() {
                /* class com.afollestad.materialdialogs.internal.MDRootLayout.AnonymousClass3 */
