...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener, OnFragmentInteractionListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mCheckView.setOnClickListener(new View.OnClickListener() {
            /* class com.zhihu.matisse.internal.ui.BasePreviewActivity.AnonymousClass1 */
        ...
        this.mOriginalLayout.setOnClickListener(new View.OnClickListener() {
            /* class com.zhihu.matisse.internal.ui.BasePreviewActivity.AnonymousClass2 */

            public void onClick(View view) {
                int access$200 = BasePreviewActivity.this.countOverMaxSize();
                if (access$200 > 0) {
                    IncapableDialog.newInstance("", BasePreviewActivity.this.getString(R.string.error_over_original_count, new Object[]{Integer.valueOf(access$200), Integer.valueOf(BasePreviewActivity.this.mSpec.originalMaxSize)})).show(BasePreviewActivity.this.getSupportFragmentManager(), IncapableDialog.class.getName());
                    return;
                }
