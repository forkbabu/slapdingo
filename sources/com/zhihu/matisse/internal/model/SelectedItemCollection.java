...
public class SelectedItemCollection {
    ...
    public IncapableCause isAcceptable(Item item) {
        ...
        if (maxSelectableReached()) {
            ...
            try {
                str = this.mContext.getResources().getQuantityString(R.plurals.error_over_count, currentMaxSelectable, Integer.valueOf(currentMaxSelectable));
            } catch (Resources.NotFoundException unused) {
                str = this.mContext.getString(R.string.error_over_count, Integer.valueOf(currentMaxSelectable));
