...
final class BitmapUtils {
    ...
    static RotateBitmapResult rotateBitmapByExif(Bitmap bitmap, ExifInterface exifInterface) {
        ...
        return new RotateBitmapResult(bitmap, attributeInt != 3 ? attributeInt != 6 ? attributeInt != 8 ? 0 : TIFFConstants.TIFFTAG_IMAGEDESCRIPTION : 90 : CipherSuite.TLS_DHE_PSK_WITH_NULL_SHA256);
    }
    ...
    /* JADX WARN: Failed to insert an additional move for type inference into block B:16:? */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v2, resolved type: android.content.ContentResolver} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v5, resolved type: android.graphics.Bitmap} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v7, resolved type: android.content.ContentResolver} */
    ...
    private static android.graphics.Bitmap decodeImage(android.content.ContentResolver r2, android.net.Uri r3, android.graphics.BitmapFactory.Options r4) throws java.io.FileNotFoundException {
        ...
        L_0x0000:
            ...
            android.graphics.Rect r1 = com.theartofdev.edmodo.cropper.BitmapUtils.EMPTY_RECT     // Catch:{ OutOfMemoryError -> 0x0011 }
