...
public class CropImageOptions implements Parcelable {
    public static final Parcelable.Creator<CropImageOptions> CREATOR = new Parcelable.Creator<CropImageOptions>() {
        /* class com.theartofdev.edmodo.cropper.CropImageOptions.AnonymousClass1 */
    ...
    public CropImageOptions() {
        ...
        this.borderLineColor = Color.argb((int) CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256, 255, 255, 255);
        ...
        this.guidelinesColor = Color.argb((int) CipherSuite.TLS_DHE_PSK_WITH_AES_128_GCM_SHA256, 255, 255, 255);
