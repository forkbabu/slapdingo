...
public class WebViewTranslate extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_web_view_translate);
        ...
        this.wv.setWebViewClient(new WebViewClient() {
            /* class com.applex.snaplingo.WebViewTranslate.AnonymousClass1 */

            public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                super.onPageStarted(webView, str, bitmap);
                WebViewTranslate.this.progressBar.setVisibility(0);
                Toast.makeText(WebViewTranslate.this, "Loading...", 0).show();
            }

            public void onPageFinished(WebView webView, String str) {
                super.onPageFinished(webView, str);
                WebViewTranslate.this.wv.setVisibility(0);
                WebViewTranslate.this.progressBar.setVisibility(8);
            }
        });
    ...
    public void onBackPressed() {
        ...
        builder.setTitle("Return to home").setMessage("Are you sure?").setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            /* class com.applex.snaplingo.WebViewTranslate.AnonymousClass2 */

            public void onClick(DialogInterface dialogInterface, int i) {
                WebViewTranslate.super.onBackPressed();
            }
