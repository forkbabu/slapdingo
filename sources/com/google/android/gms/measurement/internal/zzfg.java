...
final class zzfg implements Runnable {
    ...
    public final void run() {
        /*
            ...
            r1 = 0
            r2 = 0
            com.google.android.gms.measurement.internal.zzfc r3 = r13.zzf     // Catch:{ IOException -> 0x0105, all -> 0x00ca }
            java.net.URL r4 = r13.zza     // Catch:{ IOException -> 0x0105, all -> 0x00ca }
            java.net.HttpURLConnection r3 = r3.zza(r4)     // Catch:{ IOException -> 0x0105, all -> 0x00ca }
        ...
        L_0x003b:
            ...
            com.google.android.gms.measurement.internal.zzfc r4 = r13.zzf     // Catch:{ IOException -> 0x00c7, all -> 0x00c4 }
            com.google.android.gms.measurement.internal.zzks r4 = r4.zzg()     // Catch:{ IOException -> 0x00c7, all -> 0x00c4 }
            byte[] r5 = r13.zzb     // Catch:{ IOException -> 0x00c7, all -> 0x00c4 }
            byte[] r4 = r4.zzc(r5)     // Catch:{ IOException -> 0x00c7, all -> 0x00c4 }
            com.google.android.gms.measurement.internal.zzfc r5 = r13.zzf     // Catch:{ IOException -> 0x00c7, all -> 0x00c4 }
            com.google.android.gms.measurement.internal.zzez r5 = r5.zzr()     // Catch:{ IOException -> 0x00c7, all -> 0x00c4 }
            com.google.android.gms.measurement.internal.zzfb r5 = r5.zzx()     // Catch:{ IOException -> 0x00c7, all -> 0x00c4 }
        ...
        L_0x0082:
            ...
            goto L_0x0109
        L_0x0088:
            int r8 = r3.getResponseCode()
            java.util.Map r11 = r3.getHeaderFields()     // Catch:{ IOException -> 0x00bf, all -> 0x00ba }
            com.google.android.gms.measurement.internal.zzfc r2 = r13.zzf     // Catch:{ IOException -> 0x00b6, all -> 0x00b1 }
            byte[] r10 = com.google.android.gms.measurement.internal.zzfc.zza(r3)     // Catch:{ IOException -> 0x00b6, all -> 0x00b1 }
