...
final class zzfl extends zzgw {
    ...
    public final zzfr zzu = new zzfr(this, "firebase_feature_rollouts", null);
    public final zzfr zzv = new zzfr(this, "deferred_attribution_cache", null);
    public final zzfp zzw = new zzfp(this, "deferred_attribution_cache_timestamp", 0);
    public final zzfm zzx = new zzfm(this, "default_event_parameters", null);
    ...
    public final void f_() {
        ...
        this.zzb = new zzfo(this, "health_monitor", Math.max(0L, zzaq.zzb.zza(null).longValue()));
    }
