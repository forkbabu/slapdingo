...
class zzei<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public boolean containsKey(Object obj) {
        K k = (Comparable) obj;
        return zza(k) >= 0 || this.zzon.containsKey(k);
    }
    ...
    public V get(Object obj) {
        ...
        return zza >= 0 ? this.zzom.get(zza).getValue() : this.zzon.get(k);
    }
    ...
    public final V put(K k, V v) {
        ...
        if (size == i2) {
            ...
            zzdv().put(remove.getKey(), remove.getValue());
        }
