...
public abstract class zzcg<MessageType extends zzcg<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzas<MessageType, BuilderType> {
    ...
    public static abstract class zza<MessageType extends zzcg<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzat<MessageType, BuilderType> {
        ...
        protected zza(MessageType messagetype) {
            ...
            this.zzjt = messagetype.zza(zzg.zzkg, null, null);
        }
        ...
        public final /* synthetic */ zzat zza(zzas zzas) {
            return zza((zzcg) ((zzcg) zzas));
        }
        ...
        public void zzbf() {
            if (this.zzju) {
                MessageType zza = this.zzjt.zza(zzg.zzkg, null, null);
                zza(zza, this.zzjt);
                this.zzjt = zza;
                this.zzju = false;
            }
        ...
        public final MessageType zzbh() {
            MessageType zzbi = zzbi();
            boolean booleanValue = Boolean.TRUE.booleanValue();
            byte byteValue = ((Byte) zzbi.zza(zzg.zzkd, null, null)).byteValue();
            boolean z = true;
            if (byteValue != 1) {
                if (byteValue == 0) {
                    z = false;
                } else {
                    z = zzea.zzcm().zzp(zzbi).zzo(zzbi);
                    if (booleanValue) {
                        zzbi.zza(zzg.zzke, z ? zzbi : null, null);
                    }
                }
            }
            if (z) {
    ...
    static final class zze implements zzca<zze> {
        ...
        public final zzdp zza(zzdp zzdp, zzdo zzdo) {
            return ((zza) zzdp).zza((zzcg) ((zzcg) zzdo));
        }
    ...
    private static <T extends zzcg<T, ?>> T zza(T t, byte[] bArr) throws zzco {
        T zza2 = t.zza(zzg.zzkg, null, null);
        try {
            zzea.zzcm().zzp(zza2).zza(zza2, bArr, 0, bArr.length, new zzay());
            zzea.zzcm().zzp(zza2).zzc(zza2);
            if (((zzcg) zza2).zzex == 0) {
                return zza2;
            }
            ...
            throw new zzco(e.getMessage()).zzg(zza2);
        } catch (IndexOutOfBoundsException unused) {
            throw zzco.zzbl().zzg(zza2);
        }
    }
    ...
    protected static <T extends zzcg<T, ?>> T zzb(T t, byte[] bArr) throws zzco {
        ...
        if (zza2 != null) {
            boolean booleanValue = Boolean.TRUE.booleanValue();
            byte byteValue = ((Byte) zza2.zza(zzg.zzkd, null, null)).byteValue();
            boolean z = true;
            if (byteValue != 1) {
                if (byteValue == 0) {
                    z = false;
                    ...
                    if (booleanValue) {
                        zza2.zza(zzg.zzke, z ? zza2 : null, null);
                    }
                }
            }
            if (!z) {
