...
public final class zzbaq {
    public static final Handler zzaag = new zzdrr(Looper.getMainLooper());
    private static final String zzecp = AdView.class.getName();
    private static final String zzecq = InterstitialAd.class.getName();
    private static final String zzecr = PublisherAdView.class.getName();
    private static final String zzecs = PublisherInterstitialAd.class.getName();
    private static final String zzect = SearchAdView.class.getName();
    private static final String zzecu = AdLoader.class.getName();
    private float zzecv = -1.0f;
        ...
        if (this.zzecv < 0.0f) {
            synchronized (this) {
                if (this.zzecv < 0.0f) {
                    ...
                    this.zzecv = displayMetrics.density;
                }
            }
        }
        return Math.round(((float) i) / this.zzecv);
    }
    ...
    public final void zza(ViewGroup viewGroup, zzvh zzvh, String str, String str2) {
        zzbba.zzfd(str2);
        zza(viewGroup, zzvh, str, SupportMenu.CATEGORY_MASK, -16777216);
    }

    public final void zza(ViewGroup viewGroup, zzvh zzvh, String str) {
        zza(viewGroup, zzvh, str, -16777216, -1);
    }

    private final void zza(ViewGroup viewGroup, zzvh zzvh, String str, int i, int i2) {
        if (viewGroup.getChildCount() == 0) {
            ...
            frameLayout.addView(textView, new FrameLayout.LayoutParams(zzvh.widthPixels - zzc, zzvh.heightPixels - zzc, 17));
            viewGroup.addView(frameLayout, zzvh.widthPixels, zzvh.heightPixels);
        }
    }
    ...
    public static String zzew(String str) {
        int i = 0;
        while (i < 2) {
            try {
    ...
    public static String zza(StackTraceElement[] stackTraceElementArr, String str) {
        ...
        while (true) {
            ...
            if (!"loadAd".equalsIgnoreCase(stackTraceElement.getMethodName()) || (!zzecp.equalsIgnoreCase(className) && !zzecq.equalsIgnoreCase(className) && !zzecr.equalsIgnoreCase(className) && !zzecs.equalsIgnoreCase(className) && !zzect.equalsIgnoreCase(className) && !zzecu.equalsIgnoreCase(className))) {
                i2 = i;
            }
        }
    ...
    public final void zza(Context context, String str, String str2, Bundle bundle, boolean z) {
        zza(context, str, str2, bundle, true, new zzbap(this));
    }

    public static void zza(Context context, String str, String str2, Bundle bundle, boolean z, zzbar zzbar) {
        ...
        zzbar.zzer(appendQueryParameter.toString());
    }

    public static String zzyj() {
    ...
    public static Throwable zzd(Throwable th) {
        if (zzacq.zzdaz.get().booleanValue()) {
            return th;
        }
        ...
        while (!linkedList.isEmpty()) {
            ...
            for (StackTraceElement stackTraceElement : stackTrace) {
                if (zzex(stackTraceElement.getClassName())) {
    ...
    public static boolean zzex(String str) {
        ...
        return str.startsWith(zzacq.zzdax.get());
    }
