...
public final class zzazy {
    private static final zzbaa<Map<String, ?>> zzebs = new zzazx();
    ...
    public static String zza(zzazz zzazz) {
        return zzk(zzazz);
    }
    ...
    private static String zzk(Object obj) {
        ...
        try {
            ...
            zzaxv.zzc("Error when writing JSON.", e);
            return null;
        }
    }
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (!(jSONArray == null || jSONArray.length() == 0)) {
                        ...
                        if (obj == null) {
                            ...
                            zzaxv.zzfd(valueOf.length() != 0 ? "Expected JSONArray with at least 1 non-null element for key:".concat(valueOf) : new String("Expected JSONArray with at least 1 non-null element for key:"));
                        } else if (obj instanceof JSONObject) {
                            ...
                            zzaxv.zzfd(String.format("JSONArray with unsupported type %s for key:%s", obj.getClass().getCanonicalName(), next));
                        }
                    }
                    ...
                    zzaxv.zzfd(valueOf2.length() != 0 ? "Unsupported type for key:".concat(valueOf2) : new String("Unsupported type for key:"));
                }
            }
        }
        return bundle;
