...
public final class zzasl implements Parcelable.Creator<zzasm> {
    ...
    public final /* synthetic */ zzasm createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    zzdms = (zzdms) SafeParcelReader.createParcelable(parcel, readHeader, zzdms.CREATOR);
                    break;
                case 11:
        ...
        return new zzasm(bundle, zzbbd, applicationInfo, str, arrayList, packageInfo, str2, z, str3, zzdms, str4);
    }
}
