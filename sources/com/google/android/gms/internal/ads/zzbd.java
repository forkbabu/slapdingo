...
public final class zzbd extends zzar {
    ...
    public final com.google.android.gms.internal.ads.zzbb zza(com.google.android.gms.internal.ads.zzaa<?> r7, java.util.Map<java.lang.String, java.lang.String> r8) throws java.io.IOException, com.google.android.gms.internal.ads.zzl {
        ...
        L_0x012b:
            throw r7
            switch-data {-1->0x00c9, 0->0x00c4, 1->0x00bb, 2->0x00b2, 3->0x00ac, 4->0x00a6, 5->0x00a0, 6->0x009a, 7->0x0091, }
        */
    ...
    private static void zza(HttpURLConnection httpURLConnection, zzaa<?> zzaa) throws IOException, zzl {
        byte[] zzg = zzaa.zzg();
        if (zzg != null) {
            httpURLConnection.setDoOutput(true);
            if (!httpURLConnection.getRequestProperties().containsKey(HttpConnection.CONTENT_TYPE)) {
                httpURLConnection.setRequestProperty(HttpConnection.CONTENT_TYPE, XmpWriter.UTF8.length() != 0 ? "application/x-www-form-urlencoded; charset=".concat(XmpWriter.UTF8) : new String("application/x-www-form-urlencoded; charset="));
            }
