...
final class zzbjh extends zzbmq {
    ...
    private zzelj<zzbmq> zzfej;
    private zzelj<zzcqz> zzfek;
    private zzelj<Map<String, zzcqt<zzbmw>>> zzfel;
    private zzelj<zzbpf<zzbmw>> zzfem;
    /* access modifiers changed from: private */
    public zzelj<Set<zzbyg<zzbuf>>> zzfen;
    /* access modifiers changed from: private */
    public zzelj<Set<zzbyg<zzbwd>>> zzfeo;

    private zzbjh(zzbiz zzbiz, zzbqf zzbqf, zzdlt zzdlt, zzbrl zzbrl, zzcll zzcll, zzbxa zzbxa, zzbrx zzbrx, zzdmb zzdmb, zzdkw zzdkw, zzdir zzdir, zzdhv zzdhv) {
        this.zzeto = zzbiz;
        this.zzetj = zzbrx;
        this.zzexi = zzbqf;
        this.zzexj = zzcll;
        ...
        this.zzexu = zzekx.zzas(zzcje.zze(this.zzeto.zzerq, this.zzexs, this.zzeto.zzerr, zzbms.zzahf(), this.zzext));
        ...
        this.zzezp = zzelf.zzar(1, 0).zzau(zzbmu.zzahg()).zzbjh();
        ...
        this.zzfaj = zzddh.zzb(zzdnu.zzaug(), this.zzeto.zzerl, zzbmu.zzahg(), this.zzeto.zzert, this.zzerq, this.zzexo, this.zzfam);
        ...
        this.zzfek = new zzcrd(this.zzfej, this.zzerq, this.zzeto.zzerj, this.zzfbt, this.zzexo);
        zzelc zzbjg2 = ((zzele) zzelc.zzib(1).zza("FirstPartyRendererAppOpen", this.zzfek)).zzbjg();
        this.zzfel = zzbjg2;
    ...
    @Override // com.google.android.gms.internal.ads.zzbmq
    public final zzbmk zza(zzbpr zzbpr, zzbmn zzbmn) {
        zzelg.checkNotNull(zzbpr);
        zzelg.checkNotNull(zzbmn);
        return new zzbjk(this, zzbpr, zzbmn);
    }
}
