...
interface zzejw {
    ...
    void zza(int i, zzeer zzeer) throws IOException;

    <K, V> void zza(int i, zzehg<K, V> zzehg, Map<K, V> map) throws IOException;

    void zza(int i, Object obj, zzeih zzeih) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzeih zzeih) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzeih zzeih) throws IOException;

    void zzb(int i, List<zzeer> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzeih zzeih) throws IOException;
    ...
    @Deprecated
    void zzgy(int i) throws IOException;

    @Deprecated
    void zzgz(int i) throws IOException;
