...
public final class zzedc {
    ...
    public static ECParameterSpec zza(zzede zzede) throws NoSuchAlgorithmException {
        int i = zzedb.zzhxu[zzede.ordinal()];
        if (i == 1) {
    ...
    public static ECPublicKey zza(zzede zzede, byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ECParameterSpec zza = zza(zzede);
        ECPoint eCPoint = new ECPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2));
        zza(eCPoint, zza.getCurve());
        return (ECPublicKey) zzedf.zzhyk.zzhq("EC").generatePublic(new ECPublicKeySpec(eCPoint, zza));
    }

    public static KeyPair zza(ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        KeyPairGenerator zzhq = zzedf.zzhyj.zzhq("EC");
    ...
    public static byte[] zza(ECPrivateKey eCPrivateKey, ECPoint eCPoint) throws GeneralSecurityException {
        ...
        PublicKey generatePublic = zzedf.zzhyk.zzhq("EC").generatePublic(new ECPublicKeySpec(eCPoint, eCPrivateKey.getParams()));
        KeyAgreement zzhq = zzedf.zzhyi.zzhq("ECDH");
