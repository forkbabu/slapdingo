...
public final class zzyz extends ContentProvider {
    ...
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        zzamj zzti = zzamj.zzti();
        if (zzh == null) {
            zzbba.zzfb("Metadata was null.");
        } else {
            try {
                            ...
                            if (str == null || str.matches("^/\\d+~.+$")) {
                                if (bool == null || !bool.booleanValue()) {
                                    if (!TextUtils.isEmpty(str2)) {
                                        ...
                                        zzbba.zzee(valueOf.length() != 0 ? "The Google Mobile Ads SDK is integrated by ".concat(valueOf) : new String("The Google Mobile Ads SDK is integrated by "));
                                    } else {
                                ...
                                zzbba.zzee(valueOf2.length() != 0 ? "Publisher provided Google AdMob App ID in manifest: ".concat(valueOf2) : new String("Publisher provided Google AdMob App ID in manifest: "));
                                if (bool2 == null || !bool2.booleanValue()) {
                                    zzti.zzd(context, str);
                                }
                            } else {
    ...
    private static Bundle zzh(Context context) {
        try {
            ...
            zzbba.zzc("Failed to load metadata: Null pointer exception.", e);
            return null;
        } catch (PackageManager.NameNotFoundException e2) {
            zzbba.zzc("Failed to load metadata: Package name not found.", e2);
            return null;
        }
    }
}
