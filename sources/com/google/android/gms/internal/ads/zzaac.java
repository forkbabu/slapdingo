...
public final class zzaac {
    ...
    public final boolean zzqz() {
        return ((Boolean) zzbai.zza(this.zzvr, new zzaaf())).booleanValue() && Wrappers.packageManager(this.zzvr).checkCallingOrSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE") == 0;
    }
