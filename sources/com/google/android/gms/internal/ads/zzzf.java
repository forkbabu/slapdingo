...
public final class zzzf extends RemoteCreator<zzxn> {
    ...
    public final zzxm zzi(Context context) {
        try {
            IBinder zzb = ((zzxn) getRemoteCreatorInstance(context)).zzb(ObjectWrapper.wrap(context), 201604000);
            if (zzb == null) {
                return null;
            }
            ...
            zzbba.zzd("Could not get remote MobileAdsSettingManager.", e);
            return null;
        }
    }
    ...
    public final /* synthetic */ zzxn getRemoteCreator(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
