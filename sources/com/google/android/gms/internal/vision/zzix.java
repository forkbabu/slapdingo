...
interface zzix {
    ...
    <T> T zza(zziw<T> zziw, zzgi zzgi) throws IOException;

    <T> T zza(Class<T> cls, zzgi zzgi) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zziw<T> zziw, zzgi zzgi) throws IOException;

    <K, V> void zza(Map<K, V> map, zzhy<K, V> zzhy, zzgi zzgi) throws IOException;

    @Deprecated
    <T> T zzb(Class<T> cls, zzgi zzgi) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zziw<T> zziw, zzgi zzgi) throws IOException;

    @Deprecated
    <T> T zzc(zziw<T> zziw, zzgi zzgi) throws IOException;
