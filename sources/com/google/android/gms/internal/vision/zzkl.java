...
interface zzkl {
    ...
    void zza(int i, zzfm zzfm) throws IOException;

    <K, V> void zza(int i, zzhy<K, V> zzhy, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zziw zziw) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zziw zziw) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zziw zziw) throws IOException;

    void zzb(int i, List<zzfm> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zziw zziw) throws IOException;
