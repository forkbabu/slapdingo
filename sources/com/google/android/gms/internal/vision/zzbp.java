...
public final class zzbp {
    ...
    private zzbp(String str, Uri uri, String str2, String str3, boolean z, boolean z2, boolean z3, boolean z4, @Nullable zzcq<Context, Boolean> zzcq) {
        this.zzgu = str;
        this.zzgv = uri;
        this.zzgw = str2;
        this.zzgx = str3;
    ...
    public final <T> zzbj<T> zza(String str, T t, zzbm<T> zzbm) {
        return zzbj.zza(this, str, t, zzbm, true);
    }
}
