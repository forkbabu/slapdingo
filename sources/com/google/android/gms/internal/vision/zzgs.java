...
public enum zzgs {
    ...
    private zzgs(int i, zzgu zzgu, zzhj zzhj) {
        int i2;
        this.f29id = i;
        this.zzvz = zzgu;
        this.zzvy = zzhj;
        int i3 = zzgr.zztx[zzgu.ordinal()];
        boolean z = true;
        if (i3 == 1) {
            this.zzwa = zzhj.zzgw();
        } else if (i3 != 2) {
        ...
        this.zzwb = (zzgu != zzgu.SCALAR || (i2 = zzgr.zzty[zzhj.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : z;
    }
    ...
    static {
        ...
        for (zzgs zzgs : values) {
            zzwc[zzgs.f29id] = zzgs;
        }
    }
}
