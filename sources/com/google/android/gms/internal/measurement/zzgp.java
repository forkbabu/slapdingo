...
final class zzgp {
    ...
    static int zza(zzkc zzkc, byte[] bArr, int i, int i2, zzgo zzgo) throws IOException {
        int i3 = i + 1;
        byte b = bArr[i];
        byte b2 = b;
        if (b < 0) {
    ...
    static int zza(zzkc<?> zzkc, int i, byte[] bArr, int i2, int i3, zzik<?> zzik, zzgo zzgo) throws IOException {
        int zza = zza(zzkc, bArr, i2, i3, zzgo);
        zzik.add(zzgo.zzc);
        while (zza < i3) {
            int zza2 = zza(bArr, zza, zzgo);
            if (i != zzgo.zza) {
            ...
            zza = zza(zzkc, bArr, zza2, i3, zzgo);
            zzik.add(zzgo.zzc);
        }
        return zza;
    }
    ...
    static int zza(int i, byte[] bArr, int i2, int i3, zzkt zzkt, zzgo zzgo) throws zzij {
        if ((i >>> 3) != 0) {
            ...
            if (i4 == 0) {
                ...
                zzkt.zza(i, Long.valueOf(zzgo.zzb));
                return zzb;
            } else if (i4 == 1) {
                zzkt.zza(i, Long.valueOf(zzb(bArr, i2)));
                return i2 + 8;
            } else if (i4 == 2) {
                int zza = zza(bArr, i2, zzgo);
                int i5 = zzgo.zza;
                if (i5 < 0) {
                    ...
                    if (i5 == 0) {
                        ...
                        zzkt.zza(i, zzgt.zza(bArr, zza, i5));
                    }
                    return zza + i5;
                } else {
                    throw zzij.zza();
                ...
                zzkt.zza(i, Integer.valueOf(zza(bArr, i2)));
                return i2 + 4;
            } else {
                throw zzij.zzd();
            }
