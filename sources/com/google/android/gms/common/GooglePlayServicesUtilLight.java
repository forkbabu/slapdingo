...
public class GooglePlayServicesUtilLight {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zzaz.get()) {
            ...
            if (zzd == 0) {
                ...
                StringBuilder sb = new StringBuilder((int) TIFFConstants.TIFFTAG_COLORMAP);
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        ...
        return PlatformVersion.isAtLeastJellyBeanMR2() && (applicationRestrictions = ((UserManager) context.getSystemService("user")).getApplicationRestrictions(context.getPackageName())) != null && PdfBoolean.TRUE.equals(applicationRestrictions.getString("restricted_profile"));
    }
}
