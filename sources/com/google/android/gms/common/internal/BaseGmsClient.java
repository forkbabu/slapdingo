...
public abstract class BaseGmsClient<T extends IInterface> {
    ...
    public final class zze implements ServiceConnection {
        ...
        public final void onServiceDisconnected(ComponentName componentName) {
            synchronized (BaseGmsClient.this.zzcr) {
                IGmsServiceBroker unused = BaseGmsClient.this.zzcs = (IGmsServiceBroker) null;
            }
    ...
    protected final class zzg extends zza {
        ...
        public final boolean zzj() {
            try {
                ...
                T createServiceInterface = BaseGmsClient.this.createServiceInterface(this.zzdk);
                ...
                ConnectionResult unused = BaseGmsClient.this.zzdc = (ConnectionResult) null;
        ...
        public final /* synthetic */ void zza(Boolean bool) {
            ...
            if (i != 0) {
                if (i != 10) {
                    ...
                    if (bundle != null) {
                        t = bundle.getParcelable(BaseGmsClient.KEY_PENDING_INTENT);
                    }
                    zza(new ConnectionResult(this.statusCode, t));
                    return;
                }
                BaseGmsClient.this.zza(1, (IInterface) null);
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (this.zzcm > 0) {
            printWriter.append((CharSequence) str).append((CharSequence) "lastFailedStatus=").append((CharSequence) CommonStatusCodes.getStatusCodeString(this.zzcl));
