...
public class FastParser<T extends FastJsonResponse> {
    ...
    private static final char[] zaqv = {'r', 'u', Barcode128.CODE_BC_TO_A};
    private static final char[] zaqw = {'r', 'u', Barcode128.CODE_BC_TO_A, Typography.quote};
    private static final char[] zaqx = {'a', 'l', 's', Barcode128.CODE_BC_TO_A};
    private static final char[] zaqy = {'a', 'l', 's', Barcode128.CODE_BC_TO_A, Typography.quote};
    ...
    private final boolean zaa(java.io.BufferedReader r17, com.google.android.gms.common.server.response.FastJsonResponse r18) throws com.google.android.gms.common.server.response.FastParser.ParseException, java.io.IOException {
        ...
        L_0x02a1:
            r1.zak(r7)
            return r7
            switch-data {0->0x025a, 1->0x0244, 2->0x022e, 3->0x0218, 4->0x0202, 5->0x01ea, 6->0x01d2, 7->0x01bc, 8->0x01a7, 9->0x0195, 10->0x00d2, 11->0x005e, }
        */
    ...
    private final <T extends FastJsonResponse> ArrayList<T> zaa(BufferedReader bufferedReader, FastJsonResponse.Field<?, ?> field) throws ParseException, IOException {
        ...
        if (zaj == ']') {
            ...
            while (true) {
                try {
                    T zacn = field.zacn();
                    if (!zaa(bufferedReader, (FastJsonResponse) zacn)) {
                        return arrayList;
                    }
                    arrayList.add(zacn);
                    char zaj2 = zaj(bufferedReader);
