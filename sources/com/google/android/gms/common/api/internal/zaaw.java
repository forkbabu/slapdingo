...
public final class zaaw extends GoogleApiClient implements zabs {
    ...
    public final <C extends Api.Client> C getClient(Api.AnyClientKey<C> anyClientKey) {
        C c = this.zahd.get(anyClientKey);
    ...
    public final void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        printWriter.append((CharSequence) str).append((CharSequence) "mResuming=").print(this.zagy);
        printWriter.append((CharSequence) " mWorkQueue.size()=").print(this.zafd.size());
        printWriter.append((CharSequence) " mUnconsumedApiCalls.size()=").println(this.zahj.zald.size());
        zabr zabr = this.zagx;
        if (zabr != null) {
