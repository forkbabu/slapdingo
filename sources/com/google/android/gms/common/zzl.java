...
public class zzl {
    ...
    static String zzc(String str, zzd zzd, boolean z, boolean z2) {
        return String.format("%s: pkg=%s, sha1=%s, atk=%s, ver=%s", z2 ? "debug cert rejected" : "not whitelisted", str, Hex.bytesToStringLowercase(AndroidUtilsLight.zzj(DigestAlgorithms.SHA1).digest(zzd.getBytes())), Boolean.valueOf(z), "12451009.false");
    }
}
