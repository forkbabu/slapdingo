...
public final class AdSize {
    ...
    public static final AdSize WIDE_SKYSCRAPER = new AdSize(CipherSuite.TLS_DH_RSA_WITH_AES_128_GCM_SHA256, 600, "160x600_as");
    ...
    public final int getHeightInPixels(Context context) {
        ...
        if (i == -2) {
            return zzvh.zzc(context.getResources().getDisplayMetrics());
        }
        zzwg.zzps();
        return zzbaq.zzc(context, this.height);
    }
    ...
    public final int getWidthInPixels(Context context) {
        ...
        if (i == -1) {
            return zzvh.zzb(context.getResources().getDisplayMetrics());
        }
        zzwg.zzps();
        return zzbaq.zzc(context, this.width);
    }
