...
public class JobInfoScheduler implements WorkScheduler {
    ...
    public int getJobId(TransportContext transportContext) {
        ...
        adler32.update(this.context.getPackageName().getBytes(Charset.forName(XmpWriter.UTF8)));
        adler32.update(transportContext.getBackendName().getBytes(Charset.forName(XmpWriter.UTF8)));
