...
public abstract class OneDReader implements Reader {
    ...
    public Result decode(BinaryBitmap binaryBitmap, Map<DecodeHintType, ?> map) throws NotFoundException, FormatException {
        try {
            ...
            int i = TIFFConstants.TIFFTAG_IMAGEDESCRIPTION;
            if (resultMetadata != null && resultMetadata.containsKey(ResultMetadataType.ORIENTATION)) {
                i = (((Integer) resultMetadata.get(ResultMetadataType.ORIENTATION)).intValue() + TIFFConstants.TIFFTAG_IMAGEDESCRIPTION) % 360;
            }
            ...
            try {
                ...
                while (i9 < 2) {
                    ...
                    try {
                        ...
                        if (i9 == i3) {
                            decodeRow.putMetadata(ResultMetadataType.ORIENTATION, Integer.valueOf((int) CipherSuite.TLS_DHE_PSK_WITH_NULL_SHA256));
