...
public class IidStore {
    ...
    public java.lang.String readToken() {
        /*
            ...
            monitor-enter(r0)
            java.lang.String[] r1 = com.google.firebase.installations.local.IidStore.ALLOWABLE_SCOPES     // Catch:{ all -> 0x0034 }
    ...
    private static String getIdFromPublicKey(PublicKey publicKey) {
        try {
            byte[] digest = MessageDigest.getInstance(SecurityConstants.SHA1).digest(publicKey.getEncoded());
            digest[0] = (byte) (((digest[0] & BidiOrder.B) + 112) & 255);
    ...
    private PublicKey parseKey(String str) {
        try {
            return KeyFactory.getInstance(SecurityConstants.RSA).generatePublic(new X509EncodedKeySpec(Base64.decode(str, 8)));
