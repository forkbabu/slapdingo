...
public class PdfName extends PdfObject implements Comparable<PdfName> {
    public static final PdfName A = new PdfName(ExifInterface.GPS_MEASUREMENT_IN_PROGRESS);
    ...
    public static final PdfName ALL = new PdfName(Album.ALBUM_NAME_ALL);
    ...
    public static final PdfName DL = new PdfName(ASN1Encoding.DL);
    ...
    public static final PdfName E = new PdfName(ExifInterface.LONGITUDE_EAST);
    ...
    public static final PdfName S = new PdfName(ExifInterface.LATITUDE_SOUTH);
    ...
    public static final PdfName V = new PdfName(ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
    ...
    public static final PdfName W = new PdfName(ExifInterface.LONGITUDE_WEST);
